...
GRANT INSERT, UPDATE (email, blocked, password), DELETE ON `sleepcoach`.`users` TO 'sleepcoach'@'localhost';
...
GRANT INSERT, DELETE ON `sleepcoach`.`pages` TO 'sleepcoach'@'localhost';
