...
"use strict";function init_datetime_inputs(){$("input[type='datetime']").each((function(){$(this).flatpickr({enableTime:!0,dateFormat:"Y-m-d H:i",time_24hr:!0,weekNumbers:!0,allowInput:!0})}))}function init_date_inputs(){$("input[type='date']").each((function(){console.log(this),$(this).flatpickr({enableTime:!1,dateFormat:"Y-m-d",weekNumbers:!0,allowInput:!0})}))}function init_time_inputs(){$("input[type='time']").each((function(){$(this).flatpickr({enableTime:!0,dateFormat:"H:i",time_24hr:!0,allowInput:!0,noCalendar:!0})}))}function set_focus_btn_clcik(){$(".selfhelp-icon-btn").on("click",(function(){var t=$(this).attr("id").replace("selfhelp-icon-btn-","");$("#selfhelp-input-"+t).focus()}))}$(document).ready((function(){init_datetime_inputs(),init_date_inputs(),init_time_inputs(),set_focus_btn_clcik()}));
