...
"use strict";var dataConfigInitCalls={},dataConfigInit="dataConfigInit";function initDataConfigBuilder(){$(".dataConfigBuilderBtn").each((function(){var e=$("textarea[name*='data_config']")[0];$(this).off("click").click((function(){$(".data_config_builder_modal_holder").modal({backdrop:!1}),$(".saveDataConfig").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){var t=JSON.stringify(editor.getValue(),null,3);"[]"==t&&(t=""),$(e).val(t),$(e).trigger("change")}))}))}));var t=$(".data_config_builder")[0];if(!$(t).data(dataConfigInit)){$(t).data(dataConfigInit,!0);var a=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/dataConfig/dataConfig.json",i=null;try{i=JSON.parse($(e).val())}catch(e){i=null}$.ajax({dataType:"json",url:a,success:function(e){for(var a in editor=new JSONEditor(t,{theme:"bootstrap4",input_size:"small",custom_forms:!1,object_indent:!1,table_border:!0,table_zebrastyle:!0,tooltip:"bootstrap",iconlib:"fontawesome5",ajax:!0,schema:e,startval:i,show_errors:"always",display_required_only:!0,compact:!0}),editor.off("change").on("change",(function(){for(var e in editor.editors)if(editor.editors.hasOwnProperty(e)&&"root"!==e&&editor.watchlist&&!editor.watchlist[e]&&(e.includes("table")||e.includes("type")||e.includes("field_name"))){if(e.includes("type"))getTableNames(editor.getEditor(e).getValue(),editor,e.replace("type","table"));else if(e.includes("field_name")){var t=e.split("."),a=t[0]+"."+t[1];getTableFieldNames(this.getEditor(a+".type").getValue(),this.getEditor(a+".table").getValue(),this,e,!0)}editor.watch(e,dataConfigWatcherCallback.bind(editor,e))}})),editor.editors)if(editor.editors.hasOwnProperty(a)&&"root"!==a)if(a.includes("type")){var o=a.replace("type","table");dataConfigInitCalls[o]=!1,getTableNames(editor.getEditor(a).getValue(),editor,a.replace("type","table"),editor)}else if(a.includes("table")&&editor.getEditor(a)&&editor.getEditor(a).getValue()){o=a.replace("type","table");dataConfigInitCalls[o]=!1,getTableFieldNames(editor.getEditor(a.replace("table","type")).getValue(),editor.getEditor(a).getValue(),editor,a.replace("table","fields"),!1,editor)}}})}}))}$(document).ready((function(){initDataConfigBuilder()}));var dataConfigWatcherCallback=function(e){e.includes("type")&&this.getEditor(e)&&this.getEditor(e).getValue()?getTableNames(this.getEditor(e).getValue(),this,e.replace("type","table")):e.includes("table")&&this.getEditor(e)&&this.getEditor(e).getValue()&&getTableFieldNames(this.getEditor(e.replace("table","type")).getValue(),this.getEditor(e).getValue(),this,e.replace("table","fields"),!1)};function checkAllDataConfigInitCalls(e){var t=!0;for(var a in dataConfigInitCalls)t=dataConfigInitCalls[a]&&t;if(t)for(var i in e.editors)e.editors.hasOwnProperty(i)&&"root"!==i&&(i.includes("table")||i.includes("type")||i.includes("field_name"))&&e.watch(i,dataConfigWatcherCallback.bind(e,i))}function getTableNames(e,t,a,i){$.post(BASE_PATH+"/request/AjaxDataSource/get_table_names",{type:e},(function(e){if(e.success){var o=[];try{o=JSON.parse(e.data)}catch(t){console.log("Error while parsing",e.data)}var l=t.getEditor(a).getValue().valueOf(),r=t.getEditor(a).parent;r.original_schema.properties.table.enum=o,r.schema.properties.table.enum=o,r.removeObjectProperty("table"),delete r.cached_editors.table,r.addObjectProperty("table"),t.getEditor(a).setValue(l)}else console.log(e);i&&(dataConfigInitCalls[a]=!0,checkAllDataConfigInitCalls(i))}),"json")}function getTableFieldNames(e,t,a,i,o,l){$.post(BASE_PATH+"/request/AjaxDataSource/get_table_fields",{type:e,name:t},(function(e){if(e.success){var t=[];try{t=JSON.parse(e.data)}catch(t){console.log("Error while parsing",e.data)}if(o)(n=a.getEditor(i).parent).original_schema.properties.field_name.enum=t,n.schema.properties.field_name.enum=t,n.removeObjectProperty("field_name"),delete n.cached_editors.field_name,n.addObjectProperty("field_name");else for(var r=0;r<a.getEditor(i).rows.length;r++){var n,d=a.getEditor(i+"."+r+".field_name").getValue().valueOf();(n=a.getEditor(i+"."+r+".field_name").parent).original_schema.properties.field_name.enum=t,n.schema.properties.field_name.enum=t,n.removeObjectProperty("field_name"),delete n.cached_editors.field_name,n.addObjectProperty("field_name"),a.getEditor(i+"."+r+".field_name").setValue(d)}}else console.log(e);l&&(dataConfigInitCalls[i]=!0,checkAllDataConfigInitCalls(l))}),"json")}
...
"use strict";function _toConsumableArray(r){return _arrayWithoutHoles(r)||_iterableToArray(r)||_unsupportedIterableToArray(r)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(r,t){if(r){if("string"==typeof r)return _arrayLikeToArray(r,t);var n=Object.prototype.toString.call(r).slice(8,-1);return"Object"===n&&r.constructor&&(n=r.constructor.name),"Map"===n||"Set"===n?Array.from(r):"Arguments"===n||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?_arrayLikeToArray(r,t):void 0}}function _iterableToArray(r){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(r))return Array.from(r)}function _arrayWithoutHoles(r){if(Array.isArray(r))return _arrayLikeToArray(r)}function _arrayLikeToArray(r,t){(null==t||t>r.length)&&(t=r.length);for(var n=0,e=new Array(t);n<t;n++)e[n]=r[n];return e}function _typeof(r){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(r){return typeof r}:function(r){return r&&"function"==typeof Symbol&&r.constructor===Symbol&&r!==Symbol.prototype?"symbol":typeof r})(r)}function _objectWithoutProperties(r,t){if(null==r)return{};var n,e,a=_objectWithoutPropertiesLoose(r,t);if(Object.getOwnPropertySymbols){var o=Object.getOwnPropertySymbols(r);for(e=0;e<o.length;e++)n=o[e],t.indexOf(n)>=0||Object.prototype.propertyIsEnumerable.call(r,n)&&(a[n]=r[n])}return a}function _objectWithoutPropertiesLoose(r,t){if(null==r)return{};var n,e,a={},o=Object.keys(r);for(e=0;e<o.length;e++)n=o[e],t.indexOf(n)>=0||(a[n]=r[n]);return a}function initGraph(){$("div.graph-base").each((function(){var r=$(this).children("div.graph-plot:first"),t=parseGraphData($(this).children("div.graph-data:first"));if(null!==t){var n=drawGraph(r,t.traces,t.layout,t.config,(function(){}),!0),e=n.traces,a=n.count;new ResizeSensor(r,(function(){a===t.traces.length&&Plotly.newPlot(r[0],e,t.layout,t.config)}))}}))}function drawGraph(r,t,n,e){var a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:function(){},o=arguments.length>5&&void 0!==arguments[5]&&arguments[5],i=r.prev(),c=0,u=[],l=0,f=[];return Plotly.newPlot(r[0],[],n,e),t.forEach((function(s,p){if("data_source"in s){var h=s.data_source,y=_objectWithoutProperties(s,["data_source"]),d="data-filter-".concat(h.name);i.removeClass("d-none"),c++,o&&!f.includes(d)&&(f.push(d),window.addEventListener(d,(function(o){console.log("received event: "+d),drawGraph(r,t,n,e,a)})));var g=BASE_PATH+"/request/AjaxDataSource/get_data_table/"+h.name;$.post(g,{single_user:!!h.single_user&&h.single_user},(function(t){if(t.success){var n={};n="cb"in h?h.cb(t.data):graphTraceCb(t.data,h,p),u[p]=deepmerge(y,n),Plotly.addTraces(r[0],u[p]),l>p&&Plotly.moveTraces(r[0],l,p),l++,a(),0===--c&&i.addClass("d-none")}else console.log(t)}),"json")}else u[p]=s,l++,Plotly.addTraces(r[0],s,p)})),{count:l,traces:u}}function graphTraceCb(r,t){var n={},e=function(e){graphExpandDotString(n,e,[]);var a=t.map[e],o=graphExpandDotString(n,e,[]);Array.isArray(a)?a.forEach((function(t){var n=0;"max"===t.op?n=Math.max.apply(Math,r.map((function(r){return r[t.name]}))):"min"===t.op?n=Math.min.apply(Math,r.map((function(r){return r[t.name]}))):"sum"===t.op?n=r.reduce((function(r,n){return r+Number(n[t.name])}),0):"avg"===t.op&&(n=r.reduce((function(r,n){return r+Number(n[t.name])}),0),n/=r.length),o.push(n)})):"object"===_typeof(a)&&null!==a?graphTraceCbData(r,n,o,a.name,a.ignore,a.options,a.order,a.maps,a.children):r.forEach((function(r){o.push(r[a])}))};for(var a in t.map)e(a);return n}function graphTraceCbData(r,t,n,e,a,o,i){var c=arguments.length>7&&void 0!==arguments[7]?arguments[7]:{},u=arguments.length>8&&void 0!==arguments[8]?arguments[8]:{},l={},f={};for(var s in c)f[s]=graphExpandDotString(t,s,[]);var p=!1,h=0,y=!1,d=null;if("object"===_typeof(i)&&null!==i&&"vals"in i&&(y=!0),r.forEach((function(r){var t=r[e];if(!a||!a.includes(t)){if(!(t in l))for(var u in p=!0,l[t]=y?i.vals.indexOf(Number(t)):n.length,n[l[t]]=0,c)f[u][l[t]]=c[u][t];"count"===o.op||"percent"===o.op?n[l[t]]++:"sum"===o.op?n[l[t]]+=t:"val"===o.op?n[l[t]]=Number(t):"idx"===o.op&&p&&(n[l[t]]=h++,p=!1)}})),"percent"===o.op)for(var g=0;g<n.length;g++)n[g]/=r.length;if("range"in o&&"min"in o.range&&"max"in o.range)for(var m=Math.max.apply(Math,_toConsumableArray(n)),v=Math.min.apply(Math,_toConsumableArray(n)),b=0;b<n.length;b++)n[b]=(n[b]-v)*(o.range.max-o.range.min)/(m-v)+o.range.min;if("factor"in o)for(var _=0;_<n.length;_++)n[_]*=o.factor;if("offset"in o)for(var A=0;A<n.length;A++)n[A]+=o.offset;if("round"in o)for(var S=0;S<n.length;S++){var x=Math.pow(10,o.round);n[S]=Math.round((n[S]+Number.EPSILON)*x)/x}if(Array.isArray(i)){if("idx"!==o.op)for(var T=n.slice(),j=0;j<T.length;j++)n[j]=T[i[j]]}else if(i&&"string"==typeof i&&("asc"===i?d=sortWithIndices(n):"desc"===i&&(d=sortWithIndices(n,!1)),d))for(var w in f)for(var P=f[w].slice(),E=0;E<P.length;E++)f[w][E]=P[d[E]];if("suffix"in o)for(var O=0;O<n.length;O++)n[O]="".concat(n[O]).concat(o.suffix);for(var I in u){var C=graphExpandDotString(t,I,[]);graphTraceCbData(r,t,C,e,a,u[I],d)}}function sortWithIndices(r){for(var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=[],e=t?1:-1,a=0;a<r.length;a++)r[a]=[r[a],a];r.sort((function(r,t){return r[0]<t[0]?-1*e:1*e}));for(var o=0;o<r.length;o++)n.push(r[o][1]),r[o]=r[o][0];return n}function graphExpandDotString(r,t,n){for(var e=t.split("."),a=r,o=0;o<e.length-1;o++)e[o]in a||(a[e[o]]={}),a=a[e[o]];return a=a[e[e.length-1]]=n}function parseGraphData(r){var t=r.text();try{return JSON.parse(t)}catch(r){return console.log("cannot parse raw data of graph"),console.log(r),null}}$(document).ready((function(){initGraph()}));
...
"use strict";function initMermaidForm(){mermaid.mermaidAPI.initialize({startOnLoad:!1}),$(".mermaidForm").each((function(){var i=$(this).children("div.mermaidCode:first"),t=$(this).children("div.mermaidFormName:first").text(),e=$(this).children("div.mermaidFormEditableFields:first").text();if(0==$("#graph-mermaid").length){mermaid.mermaidAPI.render("graph-"+t,i.text(),(function(d){var r=$(d);addNodeIdPrefix(t,r),i.html(r),addPointerClassAndClickEvent(t,e)}));growNodesToFitText($("#graph-"+t))}}))}function addNodeIdPrefix(i,t){t.find(".node").each((function(){$(this).attr("id").includes(i)||$(this).attr("id",i+"_"+$(this).attr("id"))}))}function growNodesToFitText(i){var t=0;i.find(".node").each((function(){var i=$(this).find("foreignObject:first"),e=i.children("div:first"),d=parseFloat(i.attr("width")),r=e.width()-d;r>t&&(t=r);var a=$(this).children().first();i.attr("width",d+r),a.attr("width",parseFloat(a.attr("width"))+r)}));var e=parseFloat(i.css("max-width")),d=i.attr("viewBox").split(" ");d[2]=parseFloat(d[2])+t,i.css("max-width",e+t),i.attr("viewBox",d.join(" "))}function addPointerClassAndClickEvent(i,t){var e=parseEditableFields(t);for(var d in e)$("#"+i+"_"+d).addClass("pointer"),$("#"+i+"_"+d).click(function(t){return function(){onClickToEdit($(this).attr("id"),i,e[t])}}(d))}function onClickToEdit(i,t,e){$("#"+t).find(":input").each((function(){t+"_"+$(this).attr("name")==i+"[value]"?(""!=e.label?$("#"+t).find(".modal-title").html(e.label):$(this).addClass("mb-3"),$(this).addClass("mermaidFieldVisible")):$(this).prop("required",!1)})),$("#"+t).modal(),$("#"+t).on("hidden.bs.modal",(function(){$(".mermaidFieldVisible").each((function(){$(this).removeClass("mermaidFieldVisible")}))}))}function parseEditableFields(i){try{return JSON.parse(i)}catch(i){return console.log(i),{}}}$(document).ready((function(){initMermaidForm()}));
...
"use strict";$(document).ready((function(){$("iframe").on("load",(function(){iFrameResize({log:!1,heightCalculationMethod:"taggedElement"})}))}));
"use strict";function initQualtricsSurveyConfigBuilder(){$(".qualtricsConfigBuilderMonaco").each((function(){require.config({paths:{vs:BASE_PATH+"/js/ext/vs"}});var i=$(this)[0];require(["vs/editor/editor.main"],(function(){var e=setQualtricsSurveyConfigSchema(monaco,i),o={value:$(i).prev().val(),language:"json",automaticLayout:!0,renderLineHighlight:"none"};e&&(o.model=e);var t=monaco.editor.create(i,o);t.getAction("editor.action.formatDocument").run().then((function(){calcMonacoEditorSize(t,i)})),t.onDidChangeModelContent((function(e){$(i).prev().val(t.getValue()),calcMonacoEditorSize(t,i)})),showQualtricsSurveyConfigBuilder(i,t)}))}))}function setQualtricsSurveyConfigSchema(i,e){var o=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/qualtricsSurveyConfig/qualtricsSurveyConfig.json",t=i.Uri.parse(o),n=i.editor.createModel($(e).prev().val(),"json",t);i.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,enableSchemaRequest:!0,schemas:[{uri:"http://selfhelp/qualtricsSurveyConfig.json",fileMatch:[t.toString()],schema:{$schema:"http://json-schema.org/draft-07/schema#",$id:o,title:"Qualtrics Survey Config Schema",description:"Qualtrics Survey Config Schema",$ref:o}}]});return n}function showQualtricsSurveyConfigBuilder(i,e){var o,t=getQualtricsConfigJson(i);$(".qualtricsConfigBuilderBtn").each((function(){$(this).click((function(){$(".qualtricsSurveyConfig_builder_modal_holder").modal({backdrop:!1}),o&&o.setValue(getQualtricsConfigJson(i)),$(".qualtricsSurveyConfig_builder_modal_holder").on("hidden.bs.modal",(function(i){})),$(".savequaltricsSurveyConfigBuilder").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){e.getModel().setValue(JSON.stringify(o.getValue(),null,3))}))}))}))}));var n=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/qualtricsSurveyConfig/qualtricsSurveyConfig.json";$.ajax({dataType:"json",url:n,success:function(i){o=new JSONEditor($(".qualtricsSurveyConfig_builder")[0],{theme:"bootstrap4",iconlib:"fontawesome5",ajax:!0,schema:i,startval:t,show_errors:"always",display_required_only:!0})}})}function getQualtricsConfigJson(i){try{return JSON.parse($(i).prev().val())}catch(i){return null}}$(document).ready((function(){initQualtricsSurveyConfigBuilder()}));
...
"use strict";function initTabs(){if(!window.location.href.includes("cms_update")&&($(".tabs-container").find(".tab-content").each((function(){$(this).closest(".tabs-container").append($(this))})),activate_with_hash(),$(window).bind("hashchange",(function(t){activate_with_hash()})),$("button.tab-button").click((function(){console.log($(this).attr("data-context")),window.location.hash="#section-"+$(this).attr("data-context")})),!window.location.hash)){var t=$("button.tab-button").first();activate($("button.tab-button:not(.active):not(.no-anchor-expand).style-section-"+$(t).attr("data-context")))}}function activate(t){var n=".tab-content-index-"+t.attr("data-context"),a=t.closest(".tabs-container").children(n),o=t.closest(".tabs-container").children("button.tab-button");t.hasClass("active")?(t.removeClass("active"),a.slideUp("fast")):(t.addClass("active"),a.slideDown("fast")),o.not(t).removeClass("active"),t.closest(".tabs-container").children(".tab-content").not(n).hide()}function activate_with_hash(){activate($("button.tab-button:not(.active):not(.no-anchor-expand).style-"+window.location.hash.substring(1)))}$(document).ready((function(){initTabs()}));
"use strict";var jsonEditorInit="jsonEditorInit",mdInit="mdInit";function initTextarea(){initJsonFields(),initMarkdownFields()}function initJsonFields(){$(".json").each((function(){var e=$(this)[0];$(e).data(jsonEditorInit)||($(e).data(jsonEditorInit,!0),require.config({paths:{vs:BASE_PATH+"/js/ext/vs"}}),require(["vs/editor/editor.main"],(function(){var t={value:$(e).prev().val(),language:"json",automaticLayout:!0,renderLineHighlight:"none"},n=monaco.editor.create(e,t);n.getAction("editor.action.formatDocument").run().then((function(){calcMonacoEditorSize(n,e)})),n.onDidChangeModelContent((function(t){$(e).prev().val(n.getValue()),calcMonacoEditorSize(n,e),$(e).prev().trigger("change")}))})))}))}function check_textarea_locked_after_submit(){$(".selfhelpTextArea").each((function(){$(this).data("locked_after_submit")&&$(this).val()&&$(this).prop("readonly",!0)}))}function initMarkdownFields(){var e=this,t=$(".style-markdown");Array.from(t).forEach((function(t){$(t).data(mdInit)||($(t).data(mdInit,!0),new EasyMDE({element:t,autoDownloadFontAwesome:!1,spellChecker:!1,autoRefresh:{delay:0},minHeight:"10px",forceSync:!0,inputStyle:"contenteditable",toolbar:["bold","italic","heading","quote","unordered-list","ordered-list","link","image","table","preview","guide"],renderingConfig:{singleLineBreaks:!1}}).codemirror.on("change",(function(){unsavedChanges.push(e)})))}))}$(document).ready((function(){autosize($("textarea")),check_textarea_locked_after_submit(),initTextarea()}));
