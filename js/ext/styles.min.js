...
function drawGraph(e,a,t,n,r=(()=>{}),o=!1){let l=e.prev(),c=0,i=(new Date).getTime();a.forEach((function(s,p){if("data_source"in s){let{data_source:u,...f}=s,h="data-filter-"+u.name;l.removeClass("d-none"),c++,o&&window.addEventListener(h,(function(o){console.log("received event: "+h),drawGraph(e,a,t,n,r)})),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:u.name,single_user:u.single_user},(function(a){if(a.success){let o={};if(o="cb"in u?u.cb(a.data):graphTraceCb(a.data,u),0===p&&Plotly.newPlot(e[0],[],t,n),console.log(f),console.log(o),Plotly.addTraces(e[0],deepmerge(f,o)),r(),c--,0===c){l.addClass("d-none");let e=new Date;console.log(e.getTime()-i)}}else console.log(a)}),"json")}else 0===p&&Plotly.newPlot(e[0],[],t,n),Plotly.addTraces(e[0],s)}))}function graphTraceCb(e,a){let t={};for(let n in a.map){graphExpandDotString(t,n,[]);let r=a.map[n],o=n.split(".").reduce((e,a)=>e[a],t);if(Array.isArray(r))r.forEach((function(a){let t=0;"max"===a.op?t=Math.max.apply(Math,e.map((function(e){return e[a.name]}))):"min"===a.op?t=Math.min.apply(Math,e.map((function(e){return e[a.name]}))):"sum"===a.op?t=e.reduce((e,t)=>e+Number(t[a.name]),0):"avg"===a.op&&(t=e.reduce((e,t)=>e+Number(t[a.name]),0),t/=e.length),o.push(t)}));else if("object"==typeof r&&null!==r){let a={};if(graphExpandDotString(t,r.labels.key,[]),e.forEach((function(e){let n=e[r.name];if(!(n in a)){let e=r.labels.key.split(".").reduce((e,a)=>e[a],t);a[n]=o.length,o.push(0),e.push(r.labels.map[n])}"count"===r.op||"percent"===r.op?o[a[n]]++:"sum"===r.op&&(o[a[n]]+=n)})),"percent"===r.op)for(let a=0;a<o.length;a++)o[a]/=e.length;if("factor"in r)for(let e=0;e<o.length;e++)o[e]*=r.factor;if("offset"in r)for(let e=0;e<o.length;e++)o[e]+=r.offset}else e.forEach((function(e){o.push(e[r])}))}return t}function graphExpandDotString(e,a,t){for(var n=a.split("."),r=e,o=0;o<n.length-1;o++)r[n[o]]={},r=r[n[o]];r[n[n.length-1]]=t}function parseGraphData(e){var a=e.text();try{return JSON.parse(a)}catch(e){return console.log("cannot parse raw data of graph"),console.log(e),null}}$(document).ready(()=>{$("div.graph-base").each((function(){let e=$(this).children("div.graph-plot");var a=parseGraphData($(this).children("div.graph-data:first"));null!==a&&drawGraph(e,a.traces,a.layout,a.config,()=>{},!0)}))});
function graph_sankey_compute_link_sum(e,o,t){let r=0;return e.forEach((function(e){e[o.col.key]==o.type.key&&e[t.col.key]==t.type.key&&r++})),r}function graph_sankey_compute_node_position(e,o){let t=o/(e-1)+1e-5;return t>1&&(t=.99999),t}function graph_sankey_create_col_node(e,o){return{idx:o,key:e[o].key,label:e[o].label}}function graph_sankey_create_type_node(e,o){return{idx:o,key:e.key,label:e.label,color:e.color?e.color:""}}function graph_sankey_prepare_transitions(e){let o=[];for(var t=1;t<e.length;t++)o.push({source:graph_sankey_create_col_node(e,t-1),target:graph_sankey_create_col_node(e,t)});return o}function graph_sankey_postprocess_graph(e,o){e.has_node_labels||o.find("text.node-label").remove()}function graph_sankey_cb(e,o){let t=o.cols,r=o.types,n=graph_sankey_prepare_transitions(t),a={},l=0,c={source:[],target:[],value:[],color:""===o.link_color?null:[]};if(n.forEach((function(t){r.forEach((function(n,p){r.forEach((function(r,_){let i={col:t.source,type:graph_sankey_create_type_node(n,p)},s={col:t.target,type:graph_sankey_create_type_node(r,_)},y=i.col.key+"-"+i.type.key,h=s.col.key+"-"+s.type.key,u=graph_sankey_compute_link_sum(e,i,s),k="";u>=o.min&&(c.value.push(u),y in a||(i.idx=l,a[y]=i,l++),c.source.push(a[y].idx),h in a||(s.idx=l,a[h]=s,l++),c.target.push(a[h].idx),k="source"===o.link_color&&""!==i.type.color?i.type.color:"target"===o.link_color&&""!==s.type.color?s.type.color:o.link_color,""!==k&&c.color.push(k))}))}))})),c.color)for(let e=0;e<c.value.length;e++){let t=Math.trunc(255*o.link_alpha);t<0&&(t=0),t>255&&(t=255);let r=t.toString(16);1===r.length&&(r="0"+r),c.color[e]&&(c.color[e]+=r)}c.hovertemplate=o.link_hovertemplate;let p={};t.forEach((function(e,o){p[e.key]=[]}));for(let e in a){let o=a[e];p[o.col.key].push(o.type.idx)}for(let e in p)p[e].sort((e,o)=>e-o);let _={label:[],color:[],x:[],y:[]};for(let e in a){let r=a[e];if(_.label[r.idx]=r.type.label,_.color[r.idx]=r.type.color,o.is_grouped){_.x[r.idx]=graph_sankey_compute_node_position(t.length,r.col.idx);let e=p[r.col.key].indexOf(r.type.idx);_.y[r.idx]=graph_sankey_compute_node_position(p[r.col.key].length,e)}}return _.hovertemplate=o.node_hovertemplate,{link:c,node:_}}$(document).ready(()=>{$("div.graph-sankey").each((function(){let e=$(this).children("div.graph-plot");var o=parseGraphData($(this).children("div.graph-data:first")),t=parseGraphData($(this).children("div.graph-opts:first"));null!==o&&(Plotly.newPlot(e[0],[t.pre_computation],o.layout,o.config),graph_sankey_postprocess_graph(t,e),o.traces[0].data_source.cb=function(e){return graph_sankey_cb(e,t)},drawGraph(e,o.traces,o.layout,o.config,()=>{graph_sankey_postprocess_graph(t,e)},!0))}))});
