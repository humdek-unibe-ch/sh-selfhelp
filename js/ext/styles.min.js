...
"use strict";function asyncGeneratorStep(e,n,o,t,r,s,i){try{var a=e[s](i),u=a.value}catch(e){return void o(e)}a.done?n(u):Promise.resolve(u).then(t,r)}function _asyncToGenerator(e){return function(){var n=this,o=arguments;return new Promise((function(t,r){var s=e.apply(n,o);function i(e){asyncGeneratorStep(s,t,r,i,a,"next",e)}function a(e){asyncGeneratorStep(s,t,r,i,a,"throw",e)}i(void 0)}))}}function loadJobConfig(){if($("#jobConfig").length>0){var e=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/jobConfig/jobConfig.json";$.ajax({dataType:"json",url:e,success:function(e){editor=new JSONEditor($("#jobConfig")[0],{theme:"bootstrap4",iconlib:"fontawesome5",ajax:!0,schema:e,show_errors:"always"}),setDynamicEnums(editor),editor.on("ready",(function(){crrValue=!1;try{crrValue=JSON.parse($("#jobConfigValue").val())}catch(e){}crrValue&&editor.editors.root.setValue(crrValue,!0),editor.on("change",(function(){$("#jobConfig").find("select").each((function(){$(this).selectpicker(),$(this).selectpicker("refresh")})),console.log(editor.getValue()),$("#jobConfigValue").val(JSON.stringify(editor.getValue()))})),$("#jobConfig").hasClass("view-select")&&editor.disable()}))}})}}function prepareEnumSource(e){for(var n in enumValues=[],e)console.log(n,e[n]),enumValues.push({value:n,text:e[n]});return res=[],res.push({source:enumValues,title:"{{item.text}}",value:"{{item.value}}"}),res}function setDynamicEnums(e){return _setDynamicEnums.apply(this,arguments)}function _setDynamicEnums(){return(_setDynamicEnums=_asyncToGenerator(regeneratorRuntime.mark((function e(n){var o,t;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,getGroups();case 2:return o=e.sent,n.schema.definitions.job_ref.properties.job_add_remove_groups.items.enum=o,e.next=6,getLookups("actionScheduleTypes");case 6:t=e.sent,n.schema.definitions.schedule_time_ref.properties.job_schedule_types.enumSource=prepareEnumSource(t);case 8:case"end":return e.stop()}}),e)})))).apply(this,arguments)}$(document).ready((function(){loadJobConfig()}));
