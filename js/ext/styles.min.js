...
"use strict";function updateDepth(t,e){var n=t.turn("page"),r=t.turn("pages"),i=16*Math.min(1,2*n/r);(e=e||n)>3?$(".book-turnjs .p2 .depth").css({width:i,left:20-i}):$(".book-turnjs .p2 .depth").css({width:0}),i=16*Math.min(1,2*(r-n)/r),e<r-3?$(".book-turnjs .secondLast .depth").css({width:i,right:20-i}):$(".book-turnjs .secondLast .depth").css({width:0})}function getViewNumber(t,e){return parseInt((e||t.turn("page"))/2+1,10)}function setSlider(){$("#slider").slider({min:1,max:100,stop:function(){$(".book-turnjs").turn("page",Math.max(1,2*$(this).slider("value")-2))}})}$(document).ready((function(){$(".book-turnjs").each((function(){var t=!1,e=$(this).data("config");e&&'""'!=e||(e={});var n=!1;e&&e.slider?(n=!0,setSlider()):$("#slider-bar").addClass("d-none"),e.when={turning:function(n,r,i){var a=this;if($(this).turn("data").hover)return $(this).turn("data").hover=!1,void n.preventDefault();var s=$(this),u=s.turn("page"),o=s.turn("pages");if(e.saveOnTurnPage)for(var d=0;d<r;d++)for(var p=0;p<$(this).find('[page="'+d+'"]').find("input,textarea,select").filter("[required]").length;p++){var l=$(this).find('[page="'+d+'"]').find("input,textarea,select").filter("[required]")[p];if("radio"==$(l).attr("type")&&!$(this).find('[page="'+d+'"]').find('input[name="'+$(l).attr("name")+'"]:checked').val())return n.preventDefault(),s.turn("page",d),void l.reportValidity();if(!$(l).val())return n.preventDefault(),s.turn("page",d),void l.reportValidity()}if(window.location.hash="#page-"+r,u>3&&u<o-3){if(1==r)return s.turn("page",2).turn("stop").turn("page",r),void n.preventDefault();if(r==o)return s.turn("page",o-1).turn("stop").turn("page",r),void n.preventDefault()}else if(r>3&&r<o-3){if(1==u)return s.turn("page",2).turn("stop").turn("page",r),void n.preventDefault();if(u==o)return s.turn("page",o-1).turn("stop").turn("page",r),void n.preventDefault()}(updateDepth(s,r),r>=2?$(".book-turnjs .p2").addClass("fixed"):$(".book-turnjs .p2").removeClass("fixed"),r<s.turn("pages")?$(".book-turnjs .secondLast").addClass("fixed"):$(".book-turnjs .secondLast").removeClass("fixed"),e.saveOnTurnPage)&&(s.turn("view").forEach((function(t){$(a).find('[page="'+t+'"]').find(":submit").click()})),t&&$(this).parent().find("> :submit").click())},turned:function(t,e,r){var i=$(this);2!=e&&3!=e||i.turn("peel","br"),updateDepth(i),n&&$("#slider").slider("value",getViewNumber(i,e)),i.turn("center")},end:function(t,e){var r=$(this);updateDepth(r),setTimeout((function(){n&&$("#slider").slider("value",getViewNumber(r))}),1)},missing:function(t,e){},start:function(t,n,r){if(e.stopClickPageTurn&&null!=r)return $(this).turn("data").hover=!0,t.preventDefault()}},$(this).turn(e);var r=$(this),i=window.location.hash.substring(1);i?$(this).turn("page",i.replace("page-","")):t=!0,n&&$("#slider").slider("option","max",$(this).turn("pages")/2+1),$(this).addClass("animated"),$("#canvas").css({visibility:""}),e.showButtons&&($("#book-buttons").removeClass("d-none"),$("#book-buttons").addClass("d-flex"),$("#book-previous-button").click((function(t){r.turn("data").hover=!1,t.preventDefault(),r.turn("previous")})),$("#book-next-button").click((function(t){r.turn("data").hover=!1,t.preventDefault(),r.turn("next")}))),setTimeout((function(){t=!0}),2e3)}))})),$("#canvas").css({visibility:"hidden"});
...
"use strict";$(document).ready((function(){$(".json").each((function(){console.log("json"),require.config({paths:{vs:"js/ext/vs"}});var o=$(this)[0];console.log(o),require(["vs/editor/editor.main"],(function(){monaco.editor.create(o,{value:["function x() {",'\tconsole.log("Hello world!");',"}"].join("\n"),language:"javascript"})}))}))}));
...
"use strict";function check_textarea_locked_after_submit(){$(".selfhelpTextArea").each((function(){$(this).data("locked_after_submit")&&$(this).val()&&$(this).prop("readonly",!0)}))}$(document).ready((function(){autosize($("textarea")),check_textarea_locked_after_submit()}));
