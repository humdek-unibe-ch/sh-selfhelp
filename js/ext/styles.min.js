...
function drawGraph(a,e,t,n,r=(()=>{}),o=!1){let l=a.prev(),c=0;e.forEach(function(s,d){if("data_source"in s){let{data_source:i,...u}=s,p=`data-filter-${i.name}`;l.removeClass("d-none"),c++,o&&window.addEventListener(p,function(o){console.log("received event: "+p),drawGraph(a,e,t,n,r)}),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:i.name,single_user:i.single_user},function(e){if(e.success){let o={};o="cb"in i?i.cb(e.data):trace_cb(e.data,i),0===d&&Plotly.newPlot(a[0],[],t,n),Plotly.addTraces(a[0],{...u,...o}),r(),0===--c&&l.addClass("d-none")}else console.log(e)},"json")}else 0===d&&Plotly.newPlot(a[0],[],t,n),Plotly.addTraces(a[0],s)})}function trace_cb(a,e){let t={};for(let n in e.map)t[n]=[],a.forEach(function(a){t[n].push(a[e.map[n]])});return t}function parseGraphData(a){var e=a.text();try{return JSON.parse(e)}catch(a){return console.log("cannot parse raw data of graph"),console.log(a),null}}$(document).ready(()=>{$("div.graph-base").each(function(){let a=$(this).children("div.graph-plot");var e=parseGraphData($(this).children("div.graph-data:first"));null!==e&&drawGraph(a,e.traces,e.layout,e.config)})});
