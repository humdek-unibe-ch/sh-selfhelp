...
"use strict";function init_datetime_inputs(){$("input[type='datetime']").each((function(){$(this).flatpickr({enableTime:!0,dateFormat:""==$(this).attr("data-format")?"Y-m-d H:i":$(this).attr("data-format"),time_24hr:!0,weekNumbers:!1,locale:{firstDayOfWeek:1},allowInput:!0})}))}function init_date_inputs(){$("input[type='date']").each((function(){$(this).flatpickr({enableTime:!1,dateFormat:""==$(this).attr("data-format")?"Y-m-d":$(this).attr("data-format"),weekNumbers:!1,locale:{firstDayOfWeek:1},allowInput:!0})}))}function init_time_inputs(){$("input[type='time']").each((function(){$(this).flatpickr({enableTime:!0,dateFormat:""==$(this).attr("data-format")?"H:i":$(this).attr("data-format"),time_24hr:!0,allowInput:!0,noCalendar:!0})}))}function set_focus_btn_clcik(){$(".selfhelp-icon-btn").on("click",(function(){$($(this).parent().parent().find(".selfhelp-input-date")[0]).focus()}))}$(document).ready((function(){init_datetime_inputs(),init_date_inputs(),init_time_inputs(),set_focus_btn_clcik()}));
