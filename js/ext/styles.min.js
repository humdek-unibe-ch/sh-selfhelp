...
$(document).ready((function(){var t="autocomplete";$("div.input-autocomplete").each((function(){var e=$(this).children("div.input-autocomplete-search-target"),i=$(this).children("div.input-autocomplete-debug"),a=$(this).children("div.input-autocomplete-callback"),n=$(this).find("input.input-autocomplete-value"),o=$(this).find("input.input-autocomplete-search");function c(i,a){n.val(i.substr(t.length+1)),o.val(a),e.empty()}o.on("keydown",(function(i){if("Escape"===i.key)o.val(""),e.empty(),n.val("");else if("ArrowDown"===i.key||"ArrowUp"===i.key){i.preventDefault();var a,l=$(`.list-group-item-action.active[id|="${t}"]`);(a="ArrowDown"===i.key?l.next():l.prev()).hasClass("list-group-item-action")&&(l.removeClass("active"),a.addClass("active"))}else if("Enter"===i.key){i.preventDefault(),0!==(l=$(`.list-group-item-action.active[id|="${t}"]`)).length&&c(l.attr("id"),l.text())}})),o.on("keyup",(function(o){var l=$(this).val();l.length<1||"ArrowDown"!==o.key&&"ArrowUp"!==o.key&&"Enter"!==o.key&&"Escape"!==o.key&&$.post(BASE_PATH+"/request/"+a.text(),{search:l},(function(a){var o=$("<div/>",{class:"list-group"});a.success?(a.data.forEach((function(e,i){var a="";0===i&&(a=" active",n.val(e.id)),o.append($("<div/>",{class:"list-group-item list-group-item-action"+a,id:t+"-"+e.id}).append(e.value).on("click",(function(){c($(this).attr("id"),$(this).text())})))})),e.html(o)):(console.log(a),i.html(a.data))}),"json")}))}))}));
function toggle_collapsible_card(a){var l=a,o=a.find("i.card-icon-collapse"),s=a.next();s.hasClass("show")?s.hide("fast",(function(){s.removeClass("show"),l.addClass("collapsed"),o.removeClass("fa-angle-double-up"),o.addClass("fa-angle-double-down")})):s.show("fast",(function(){s.addClass("show"),l.removeClass("collapsed"),o.removeClass("fa-angle-double-down"),o.addClass("fa-angle-double-up")}))}$(document).ready((function(){toggle_collapsible_card($(".style-"+window.location.hash.substring(1)+".card:not(.no-anchor-expand) > .card-header.collapsible.collapsed")),$("div.card-header.collapsible").on("click",(function(){toggle_collapsible_card($(this))}))}));
...
function filterInit(e,a){$("div.filter-"+e).each((function(e){let t=$(this),n=parseFilterData(t.children("div.filter-data")),o=new Event("data-filter-"+n.data_source);a(t,n,o)}))}function filterEventHandler(e,a,t,n,o){e.removeClass("d-none"),$.post(BASE_PATH+"/request/AjaxDataSource/set_data_filter",{action:a.hasClass("active")?"rm":"add",name:n.name,value:n.value[t],value_idx:t,data_source:n.data_source},(function(t){t.success?(console.log("dispatch event: "+o.type),window.dispatchEvent(o),e.addClass("d-none"),a.toggleClass("active")):console.log(t)}),"json")}function parseFilterData(e){var a=e.text();try{return JSON.parse(a)}catch(e){return console.log("cannot parse raw data of graph"),console.log(e),null}}
function filterToggleActionHandler(t,e,i){t.find("button.filter-toggle-switch").each((function(t){let n=$(this),l=n.children("i.filter-toggle-pending");n.click((function(){filterEventHandler(l,n,t,e,i)}))}))}$(document).ready(()=>{filterInit("toggle",filterToggleActionHandler)});
$(document).ready(()=>{filterInit("toggle-group",filterToggleActionHandler)});
function drawGraph(e,n,t,r,a=(()=>{}),o=!1){let l=e.prev(),i=0,c=[],s=0,f=[];return Plotly.newPlot(e[0],[],t,r),n.forEach((function(u,p){if("data_source"in u){let{data_source:h,...g}=u,d="data-filter-"+h.name;l.removeClass("d-none"),i++,o&&!f.includes(d)&&(f.push(d),window.addEventListener(d,(function(o){console.log("received event: "+d),drawGraph(e,n,t,r,a)}))),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:h.name,single_user:!!h.single_user&&h.single_user},(function(n){if(n.success){let t={};t="cb"in h?h.cb(n.data):graphTraceCb(n.data,h,p),c[p]=deepmerge(g,t),Plotly.addTraces(e[0],c[p]),s>p&&Plotly.moveTraces(e[0],s,p),s++,a(),i--,0===i&&l.addClass("d-none")}else console.log(n)}),"json")}else c[p]=u,s++,Plotly.addTraces(e[0],u,p)})),{count:s,traces:c}}function graphTraceCb(e,n){let t={};for(let r in n.map){graphExpandDotString(t,r,[]);let a=n.map[r],o=graphExpandDotString(t,r,[]);Array.isArray(a)?a.forEach((function(n){let t=0;"max"===n.op?t=Math.max.apply(Math,e.map((function(e){return e[n.name]}))):"min"===n.op?t=Math.min.apply(Math,e.map((function(e){return e[n.name]}))):"sum"===n.op?t=e.reduce((e,t)=>e+Number(t[n.name]),0):"avg"===n.op&&(t=e.reduce((e,t)=>e+Number(t[n.name]),0),t/=e.length),o.push(t)})):"object"==typeof a&&null!==a?graphTraceCbData(e,t,o,a.name,a.ignore,a.options,a.order,a.maps,a.children):e.forEach((function(e){o.push(e[a])}))}return t}function graphTraceCbData(e,n,t,r,a,o,l,i={},c={}){let s={},f={};for(let e in i)f[e]=graphExpandDotString(n,e,[]);let u=!1,p=0,h=!1,g=null;if(console.log(r),console.log(l),"object"==typeof l&&null!==l&&"vals"in l&&(console.log(!0),console.log(l),h=!0),e.forEach((function(e){let n=e[r];if(!a||!a.includes(n)){if(!(n in s)){u=!0,s[n]=h?l.vals.indexOf(Number(n)):t.length,t[s[n]]=0;for(let e in i)f[e][s[n]]=i[e][n]}"count"===o.op||"percent"===o.op?t[s[n]]++:"sum"===o.op?t[s[n]]+=n:"val"===o.op?t[s[n]]=Number(n):"idx"===o.op&&u&&(t[s[n]]=p++,u=!1)}})),"percent"===o.op)for(let n=0;n<t.length;n++)t[n]/=e.length;if("range"in o&&"min"in o.range&&"max"in o.range){let e=Math.max(...t),n=Math.min(...t);for(let r=0;r<t.length;r++)t[r]=(t[r]-n)*(o.range.max-o.range.min)/(e-n)+o.range.min}if("factor"in o)for(let e=0;e<t.length;e++)t[e]*=o.factor;if("offset"in o)for(let e=0;e<t.length;e++)t[e]+=o.offset;if("round"in o)for(let e=0;e<t.length;e++){let n=Math.pow(10,o.round);t[e]=Math.round((t[e]+Number.EPSILON)*n)/n}if(Array.isArray(l)){if("idx"!==o.op){let e=t.slice();for(let n=0;n<e.length;n++)t[n]=e[l[n]]}}else if(l&&"string"==typeof l&&("asc"===l?g=sortWithIndices(t):"desc"===l&&(g=sortWithIndices(t,!1)),g))for(let e in f){let n=f[e].slice();for(let t=0;t<n.length;t++)f[e][t]=n[g[t]]}if("suffix"in o)for(let e=0;e<t.length;e++)t[e]=`${t[e]}${o.suffix}`;for(let t in c){graphTraceCbData(e,n,graphExpandDotString(n,t,[]),r,a,c[t],g)}}function sortWithIndices(e,n=!0){let t=[],r=n?1:-1;for(var a=0;a<e.length;a++)e[a]=[e[a],a];e.sort((function(e,n){return e[0]<n[0]?-1*r:1*r}));for(var o=0;o<e.length;o++)t.push(e[o][1]),e[o]=e[o][0];return t}function graphExpandDotString(e,n,t){for(var r=n.split("."),a=e,o=0;o<r.length-1;o++)r[o]in a||(a[r[o]]={}),a=a[r[o]];return a=a[r[r.length-1]]=t}function parseGraphData(e){var n=e.text();try{return JSON.parse(n)}catch(e){return console.log("cannot parse raw data of graph"),console.log(e),null}}$(document).ready(()=>{$("div.graph-base").each((function(){let e=$(this).children("div.graph-plot:first");var n=parseGraphData($(this).children("div.graph-data:first"));if(null===n)return;let{traces:t,count:r}=drawGraph(e,n.traces,n.layout,n.config,()=>{},!0);new ResizeSensor(e,(function(){r===n.traces.length&&Plotly.newPlot(e[0],t,n.layout,n.config)}))}))});
$(document).ready((function(){$(".graphLegend-item").each((function(){let e=$(this).children("i.graphLegend-square").first(),i=$(this).children("div.graphLegend-color").first().text();e.css("color",i)}))}));
function graph_sankey_compute_link_sum(e,o,t){let r=0;return e.forEach((function(e){e[o.col.key]==o.type.key&&e[t.col.key]==t.type.key&&r++})),r}function graph_sankey_compute_node_position(e,o){let t=o/(e-1)+1e-5;return t>1&&(t=.99999),t}function graph_sankey_create_col_node(e,o){return{idx:o,key:e[o].key,label:e[o].label}}function graph_sankey_create_type_node(e,o){return{idx:o,key:e.key,label:e.label,color:e.color?e.color:""}}function graph_sankey_prepare_transitions(e){let o=[];for(var t=1;t<e.length;t++)o.push({source:graph_sankey_create_col_node(e,t-1),target:graph_sankey_create_col_node(e,t)});return o}function graph_sankey_postprocess_graph(e,o){e.has_node_labels||o.find("text.node-label").remove()}function graph_sankey_cb(e,o){let t=o.cols,r=o.types,n=graph_sankey_prepare_transitions(t),a={},l=0,c={source:[],target:[],value:[],color:""===o.link_color?null:[]};if(n.forEach((function(t){r.forEach((function(n,p){r.forEach((function(r,_){let i={col:t.source,type:graph_sankey_create_type_node(n,p)},s={col:t.target,type:graph_sankey_create_type_node(r,_)},y=i.col.key+"-"+i.type.key,h=s.col.key+"-"+s.type.key,u=graph_sankey_compute_link_sum(e,i,s),k="";u>=o.min&&(c.value.push(u),y in a||(i.idx=l,a[y]=i,l++),c.source.push(a[y].idx),h in a||(s.idx=l,a[h]=s,l++),c.target.push(a[h].idx),k="source"===o.link_color&&""!==i.type.color?i.type.color:"target"===o.link_color&&""!==s.type.color?s.type.color:o.link_color,""!==k&&c.color.push(k))}))}))})),c.color)for(let e=0;e<c.value.length;e++){let t=Math.trunc(255*o.link_alpha);t<0&&(t=0),t>255&&(t=255);let r=t.toString(16);1===r.length&&(r="0"+r),c.color[e]&&(c.color[e]+=r)}c.hovertemplate=o.link_hovertemplate;let p={};t.forEach((function(e,o){p[e.key]=[]}));for(let e in a){let o=a[e];p[o.col.key].push(o.type.idx)}for(let e in p)p[e].sort((e,o)=>e-o);let _={label:[],color:[],x:[],y:[]};for(let e in a){let r=a[e];if(_.label[r.idx]=r.type.label,_.color[r.idx]=r.type.color,o.is_grouped){_.x[r.idx]=graph_sankey_compute_node_position(t.length,r.col.idx);let e=p[r.col.key].indexOf(r.type.idx);_.y[r.idx]=graph_sankey_compute_node_position(p[r.col.key].length,e)}}return _.hovertemplate=o.node_hovertemplate,{link:c,node:_}}$(document).ready(()=>{$("div.graph-sankey").each((function(){let e=$(this).children("div.graph-plot");var o=parseGraphData($(this).children("div.graph-data:first")),t=parseGraphData($(this).children("div.graph-opts:first"));if(null===o)return;Plotly.newPlot(e[0],[t.pre_computation],o.layout,o.config),graph_sankey_postprocess_graph(t,e),o.traces[0].data_source.cb=function(e){return graph_sankey_cb(e,t)};let{traces:r,count:n}=drawGraph(e,o.traces,o.layout,o.config,()=>{graph_sankey_postprocess_graph(t,e)},!0);new ResizeSensor(e,(function(){n===o.traces.length&&(Plotly.newPlot(e[0],r,o.layout,o.config),graph_sankey_postprocess_graph(t,e))}))}))});
...
$(document).ready((function(){$(".list-search").on("keyup",(function(){var s=$(this).val();$(this).parent().next().find("a,span").each((function(a){$(this).text().search(s)<0?$(this).parent().hide():($(this).parent().show(),$(this).parents("div.collapse").collapse("show"))}))})),$(".clear-search").on("click",(function(){$(this).prev().val(""),$(this).parent().next().find("a,span").each((function(s){$(this).parent().show()}))})),$(".nested-list a").on("click",(function(s){s.stopPropagation()})),$(".nested-list div.collapsible").on("click",(function(s){var a=$(this).next();a.hasClass("show")?a.hide("fast",(function(){a.removeClass("show")})):a.show("fast",(function(){a.addClass("show")}));var n=$(this).children(".fas:first");n.hasClass("fa-chevron-right")?n.removeClass("fa-chevron-right").addClass("fa-chevron-down"):n.hasClass("fa-chevron-down")&&n.removeClass("fa-chevron-down").addClass("fa-chevron-right")})),$(".nested-list-menu-responsive.collapsed").click((function(){var s=$(this).next();s.hasClass("show")?s.hide((function(){s.removeClass("show")})):s.show((function(){s.addClass("show")}))}))}));
$(document).ready((function(){var e=$('input[name="user_input_remove_id"]');$(".remove-user-input-field").click((function(){var t=[];$(this).siblings('[id|="user-input-field"]').each((function(){var e=$(this).attr("id").split("-");t.push(e[e.length-1])})),e.val(t)})),$(".showUserInput").each((function(){var e=$(this).attr("class").split(" "),t={columnDefs:[]};t.columnDefs.push({orderable:e.includes("dt-sortable"),targets:"_all"}),t.searching=e.includes("dt-searching"),t.bPaginate=e.includes("dt-bPaginate"),t.bInfo=e.includes("dt-bInfo");var n=e.filter((function(e){return e.includes("dt-order")}));for(let e=0;e<n.length;e++){const s=n[e].split("-");4==s.length&&(s[2]!=parseInt(s[2],10)||"asc"!==s[3]&&"desc"!==s[3]||(t.order||(t.order=[]),t.order.push([s[2],s[3]])))}n=e.filter((function(e){return e.includes("dt-hide")}));for(let e=0;e<n.length;e++){const s=n[e].split("-");3==s.length&&s[2]==parseInt(s[2],10)&&t.columnDefs.push({targets:[parseInt(s[2],10)],visible:!1})}$(this).DataTable(t)}))}));
...
$(document).ready((function(){$(".tabs-container").find(".tab-content").each((function(){$(this).closest(".tabs-container").append($(this))})),$("button.tab-button").click((function(){var t=".tab-content-index-"+$(this).attr("data-context"),n=$(this).closest(".tabs-container").children(t),s=$(this).closest(".tabs-container").children("button.tab-button");$(this).hasClass("active")?($(this).removeClass("active"),n.slideUp("fast")):($(this).addClass("active"),n.slideDown("fast")),s.not($(this)).removeClass("active"),$(this).closest(".tabs-container").children(".tab-content").not(t).hide()}))}));
