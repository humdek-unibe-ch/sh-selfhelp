...
$(document).ready(function(){$(".list-search").on("keyup",function(){var s=$(this).val();$(this).parent().next().find("a,span").each(function(n){$(this).text().search(s)<0?$(this).parent().hide():($(this).parent().show(),$(this).parents("div.collapse").collapse("show"))})}),$(".clear-search").on("click",function(){$(this).prev().val(""),$(this).parent().next().find("a,span").each(function(s){$(this).parent().show()})}),$(".nested-list a").on("click",function(s){s.stopPropagation()}),$(".nested-list div.collapsible").on("click",function(s){var n=$(this).next();n.hasClass("show")?n.hide("fast",function(){n.removeClass("show")}):n.show("fast",function(){n.addClass("show")}),$chevron=$(this).children(".fas:first"),$chevron.hasClass("fa-chevron-right")?$chevron.removeClass("fa-chevron-right").addClass("fa-chevron-down"):$chevron.hasClass("fa-chevron-down")&&$chevron.removeClass("fa-chevron-down").addClass("fa-chevron-right")}),$(".nested-list-menu-responsive.collapsed").click(function(){var s=$(this).next();s.hasClass("show")?s.hide(function(){s.removeClass("show")}):s.show(function(){s.addClass("show")})})});
