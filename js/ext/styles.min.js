...
"use strict";$(document).ready((function(){var e=$('input[name="user_input_remove_id"]');$(".remove-user-input-field").click((function(){var t=[];$(this).siblings('[id|="user-input-field"]').each((function(){var e=$(this).attr("id").split("-");t.push(e[e.length-1])})),e.val(t)})),$(".showUserInput").each((function(){var e=$(this).attr("class").split(" "),t={columnDefs:[]};t.columnDefs.push({orderable:e.includes("dt-sortable"),targets:"_all"}),t.searching=e.includes("dt-searching"),t.bPaginate=e.includes("dt-bPaginate"),t.bInfo=e.includes("dt-bInfo"),t.scrollX=!0;for(var n=e.filter((function(e){return e.includes("dt-order")})),r=0;r<n.length;r++){var s=n[r].split("-");4==s.length&&(s[2]!=parseInt(s[2],10)||"asc"!==s[3]&&"desc"!==s[3]||(t.order||(t.order=[]),t.order.push([s[2],s[3]])))}n=e.filter((function(e){return e.includes("dt-hide")}));for(var i=0;i<n.length;i++){var a=n[i].split("-");3==a.length&&a[2]==parseInt(a[2],10)&&t.columnDefs.push({targets:[parseInt(a[2],10)],visible:!1})}$(this).DataTable(t)}))}));
...
"use strict";var jsonLogicOperators={field_equal:{op:"=="},field_not_equal:{op:"!="},field_greater:{op:">"},field_less:{op:"<"},equal:{op:"=="},not_equal:{op:"!="},greater:{op:">"},less:{op:"<"},less_or_equal:{op:"<="},greater_or_equal:{op:">="},not_in:{op:"!="},in:{op:"=="},in_one_of:{op:"=="}},dataConfigInitCalls={};function calcMonacoEditorSize(e,t){var o=19*e.getModel().getLineCount();o<100&&(o=100),o>500&&(o=500),$(t).height(o),e.layout()}function setDataConfigSchema(e,t){var o=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/dataConfig/dataConfig.json",a=e.Uri.parse(o),i=e.editor.createModel($(t).prev().val(),"json",a);return e.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,enableSchemaRequest:!0,schemas:[{uri:"http://selfhelp/dataConfig.json",fileMatch:[a.toString()],schema:{$schema:o,$id:o,title:"Data config Schema",description:"Data config JSON schema",$ref:o}}]}),i}function setConditionSchema(e,t){var o=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/json-logic/json-logic.json",a=e.Uri.parse(o),i=e.editor.createModel($(t).prev().val(),"json",a);e.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,enableSchemaRequest:!0,schemas:[{uri:"http://selfhelp/json-logic.json",fileMatch:[a.toString()],schema:{$schema:"http://json-schema.org/draft-07/schema#",$id:o,title:"JSON-Logic Schema",description:"Build complex rules, serialize them as JSON, share them between front-end and back-end.",$ref:o}}]});return i}function setQualtricsSurveyConfigSchema(e,t){var o=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/qualtricsSurveyConfig/qualtricsSurveyConfig.json",a=e.Uri.parse(o),i=e.editor.createModel($(t).prev().val(),"json",a);e.languages.json.jsonDefaults.setDiagnosticsOptions({validate:!0,enableSchemaRequest:!0,schemas:[{uri:"http://selfhelp/qualtricsSurveyConfig.json",fileMatch:[a.toString()],schema:{$schema:"http://json-schema.org/draft-07/schema#",$id:o,title:"Qualtrics Survey Config Schema",description:"Qualtrics Survey Config Schema",$ref:o}}]});return i}function check_textarea_locked_after_submit(){$(".selfhelpTextArea").each((function(){$(this).data("locked_after_submit")&&$(this).val()&&$(this).prop("readonly",!0)}))}function getJson(e){try{return JSON.parse($(e).prev().val())}catch(e){return console.log("Error parsing the data_config value!"),null}}function showDataConfiBuilder(e,t){var o,a=getJson(e);$(".dataConfigBuilderBtn").each((function(){$(this).click((function(){$(".data_config_builder_modal_holder").modal({backdrop:!1}),o&&o.setValue(getJson(e)),$(".data_config_builder_modal_holder").on("hidden.bs.modal",(function(e){})),$(".saveDataConfig").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){t.getModel().setValue(JSON.stringify(o.getValue(),null,3))}))}))}))}));var i=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/dataConfig/dataConfig.json";$.ajax({dataType:"json",url:i,success:function(e){for(var t in(o=new JSONEditor($(".data_config_builder")[0],{theme:"bootstrap4",iconlib:"fontawesome5",ajax:!0,schema:e,startval:a,show_errors:"always",display_required_only:!0})).on("change",(function(){for(var e in o.editors)if(o.editors.hasOwnProperty(e)&&"root"!==e&&o.watchlist&&!o.watchlist[e]&&(e.includes("table")||e.includes("type")||e.includes("field_name"))){if(e.includes("type"))getTableNames(o.getEditor(e).getValue(),o,e.replace("type","table"));else if(e.includes("field_name")){var t=e.split("."),a=t[0]+"."+t[1];getTableFieldNames(this.getEditor(a+".type").getValue(),this.getEditor(a+".table").getValue(),this,e,!0)}o.watch(e,dataConfigWatcherCallback.bind(o,e))}})),o.editors)if(o.editors.hasOwnProperty(t)&&"root"!==t)if(t.includes("type")){var i=t.replace("type","table");dataConfigInitCalls[i]=!1,getTableNames(o.getEditor(t).getValue(),o,t.replace("type","table"),o)}else if(t.includes("table")&&o.getEditor(t)&&o.getEditor(t).getValue()){i=t.replace("type","table");dataConfigInitCalls[i]=!1,getTableFieldNames(o.getEditor(t.replace("table","type")).getValue(),o.getEditor(t).getValue(),o,t.replace("table","fields"),!1,o)}}})}$(document).ready((function(){autosize($("textarea")),check_textarea_locked_after_submit(),$(".json").each((function(){require.config({paths:{vs:BASE_PATH+"/js/ext/vs"}});var e=$(this)[0];$(e).prev().attr("name").includes("jquery_builder_json")?$(e).parent().parent().addClass("d-none"):require(["vs/editor/editor.main"],(function(){var t=null;$(e).prev().attr("name").includes("data_config")?t=setDataConfigSchema(monaco,e):$(e).prev().attr("name").includes("condition")?t=setConditionSchema(monaco,e):$(e).prev().parent().attr("class")&&$(e).prev().parent().attr("class").includes("qualtricsSurveyConfig")&&(t=setQualtricsSurveyConfigSchema(monaco,e));var o={value:$(e).prev().val(),language:"json",automaticLayout:!0,renderLineHighlight:"none"};t&&(o.model=t);var a=monaco.editor.create(e,o);if(a.getAction("editor.action.formatDocument").run().then((function(){calcMonacoEditorSize(a,e)})),a.onDidChangeModelContent((function(t){$(e).prev().val(a.getValue()),calcMonacoEditorSize(a,e)})),$(e).prev().attr("name").includes("data_config"))showDataConfiBuilder(e,a);else if($(e).prev().attr("name").includes("condition")){$("textarea").each((function(){$(this).attr("name")&&$(this).attr("name").includes("jquery_builder_json")&&(i=this)})),showConditionBuilder(a,i)}else if($(e).prev().parent().attr("class")&&$(e).prev().parent().attr("class").includes("qualtricsSurveyConfig"))showQualtricsSurveyConfiBuilder(e,a);else if($(e).prev().parent().attr("class")&&$(e).prev().parent().attr("class").includes("actionConfig")){var i;showActionConfiBuilder(e,a),$("textarea").each((function(){$(this).attr("class")&&$(this).attr("class").includes("action_condition_builder")&&(i=this)})),showConditionBuilder(a,i),showActionConditionBuilder(a,i)}}))}))}));var dataConfigWatcherCallback=function(e){e.includes("type")&&this.getEditor(e)&&this.getEditor(e).getValue()?getTableNames(this.getEditor(e).getValue(),this,e.replace("type","table")):e.includes("table")&&this.getEditor(e)&&this.getEditor(e).getValue()&&getTableFieldNames(this.getEditor(e.replace("table","type")).getValue(),this.getEditor(e).getValue(),this,e.replace("table","fields"),!1)};function checkAllDataConfigInitCalls(e){var t=!0;for(var o in dataConfigInitCalls)t=dataConfigInitCalls[o]&&t;if(t)for(var a in e.editors)e.editors.hasOwnProperty(a)&&"root"!==a&&(a.includes("table")||a.includes("type")||a.includes("field_name"))&&e.watch(a,dataConfigWatcherCallback.bind(e,a))}function getTableNames(e,t,o,a){$.post(BASE_PATH+"/request/AjaxDataSource/get_table_names",{type:e},(function(e){if(e.success){var i=[];try{i=JSON.parse(e.data)}catch(t){console.log("Error while parsing",e.data)}var n=t.getEditor(o).parent;n.original_schema.properties.table.enum=i,n.schema.properties.table.enum=i,n.removeObjectProperty("table"),delete n.cached_editors.table,n.addObjectProperty("table")}else console.log(e);a&&(dataConfigInitCalls[o]=!0,checkAllDataConfigInitCalls(a))}),"json")}function getTableFieldNames(e,t,o,a,i,n){$.post(BASE_PATH+"/request/AjaxDataSource/get_table_fields",{type:e,name:t},(function(e){if(e.success){var t=[];try{t=JSON.parse(e.data)}catch(t){console.log("Error while parsing",e.data)}if(i)(l=o.getEditor(a).parent).original_schema.properties.field_name.enum=t,l.schema.properties.field_name.enum=t,l.removeObjectProperty("field_name"),delete l.cached_editors.field_name,l.addObjectProperty("field_name");else for(var r=0;r<o.getEditor(a).rows.length;r++){var l,s=o.getEditor(a+"."+r+".field_name").getValue().valueOf();(l=o.getEditor(a+"."+r+".field_name").parent).original_schema.properties.field_name.enum=t,l.schema.properties.field_name.enum=t,l.removeObjectProperty("field_name"),delete l.cached_editors.field_name,l.addObjectProperty("field_name"),o.getEditor(a+"."+r+".field_name").setValue(s)}}else console.log(e);n&&(dataConfigInitCalls[a]=!0,checkAllDataConfigInitCalls(n))}),"json")}function getGroups(e,t){$.post(BASE_PATH+"/request/AjaxDataSource/get_groups",{},(function(o){if(o.success){var a=[];try{a=JSON.parse(o.data)}catch(e){console.log("Error while parsing JSON",o.data)}prepareConditionBuilder(a,e,t)}else console.log(o)}),"json")}function prepareConditionBuilder(e,t,o){var a={icons:{add_group:"fas fa-plus-circle",add_rule:"fas fa-plus",remove_group:"fas fa-minus-square",remove_rule:"fas fa-minus-circle",error:"fas fa-exclamation-triangle",sortable:"fas fa-exclamation-triangle"},operators:$.fn.queryBuilder.constructor.DEFAULTS.operators.concat([{type:"field_equal",optgroup:"",nb_inputs:2,multiple:!1,apply_to:["string"]},{type:"field_not_equal",optgroup:"",nb_inputs:2,multiple:!1,apply_to:["string"]},{type:"field_greater",optgroup:"",nb_inputs:2,multiple:!1,apply_to:["string"]},{type:"field_less",optgroup:"",nb_inputs:2,multiple:!1,apply_to:["string"]},{type:"field_between",optgroup:"",nb_inputs:3,multiple:!1,apply_to:["string"]},{type:"between_dates",optgroup:"",nb_inputs:2,multiple:!1,apply_to:["date"]},{type:"in_one_of",optgroup:"",nb_inputs:1,multiple:!0,apply_to:["array"]}]),lang:{operators:{field_between:"[Field Name] between [value1(number)] and [value2(number)]",field_greater:"[Field Name] > [value(number)]",field_less:"[Field Name] < [value(number)]",field_equal:"[Field Name] = [value]",field_not_equal:"[Field Name] <> [value]",between_dates:"between",in_one_of:"in one of"}},filters:[{id:"user_group",label:"User group",type:"string",input:"select",multiple:!0,values:e,plugin:"selectpicker",plugin_config:{liveSearch:!0,width:"auto",liveSearchStyle:"contains"},operators:["in","not_in","in_one_of"]},{id:"field",label:"Field",type:"string",input:"text",operators:["field_equal","field_not_equal","field_greater","field_less","field_between"]},{id:"__current_date__",label:"Current Date",type:"date",validation:{format:"DD-MM-YYYY"},plugin:"flatpickr",plugin_config:{enableTime:!1,dateFormat:"d-m-Y",time_24hr:!0,weekNumbers:!0,locale:{firstDayOfWeek:1}},operators:["equal","not_equal","less","less_or_equal","greater","greater_or_equal","between_dates"]},{id:"__current_date_time__",label:"Current Datetime",type:"date",validation:{format:"DD-MM-YYYY HH:mm"},plugin:"flatpickr",plugin_config:{enableTime:!0,dateFormat:"d-m-Y H:i",time_24hr:!0,weekNumbers:!0,locale:{firstDayOfWeek:1}},operators:["less","less_or_equal","greater","greater_or_equal","between_dates"]},{id:"__current_time__",label:"Current Time",type:"date",validation:{format:"HH:mm"},plugin:"flatpickr",plugin_config:{enableTime:!0,dateFormat:"H:i",time_24hr:!0,noCalendar:!0},operators:["less","less_or_equal","greater","greater_or_equal","between_dates"]},{id:"__keyword__",label:"Page Keyword",type:"string",input:"text",operators:["equal","not_equal"]}]},i=null;try{if($(t).val())i=JSON.parse($(t).val());else try{var n=JSON.parse(o.getModel().getValue());n&&n.condition_jquerBuilderJson&&(i=n.condition_jquerBuilderJson)}catch(e){}}catch(e){console.log("Rules cannto be parsed")}i&&(a.rules=i),$(".condition_builder").length>0?$(".condition_builder").queryBuilder(a):$(".action_condition_builder").length>0&&$(".action_condition_builder").queryBuilder(a)}function showConditionBuilder(e,t){$(".conditionBuilderBtn").each((function(){$(this).click((function(){$(".condition_builder_modal_holder").modal({backdrop:!1}),$(".condition_builder_modal_holder").on("hidden.bs.modal",(function(e){})),$(".saveConditionBuilder").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){var o=$(".condition_builder").queryBuilder("getRules");$(t).val(JSON.stringify(o)),e.getModel().setValue(JSON.stringify(rulesToJsonLogic(o),null,3))}))}))}))})),getGroups(t,e)}function convertRules(e){var t={};return e&&e.condition?(t[e.condition]=[],e.rules.forEach((function(o){var a="user_group"==o.field?"$":"",i="DD-MM-YYYY HH:mm",n="YYYY-MM-DD HH:mm";if("__current_date__"==o.field?(i="DD-MM-YYYY",n="YYYY-MM-DD"):"__current_time__"==o.field&&(i="HH:mm",n="HH:mm"),["in","not_in"].includes(o.operator))o.value.forEach((function(i){var n={};n[jsonLogicOperators[o.operator].op]=[!0,a+i],t[e.condition].push(n)}));else if("in_one_of"==o.operator)t[e.condition]={or:[]},o.value.forEach((function(i){var n={};n[jsonLogicOperators[o.operator].op]=[!0,a+i],t[e.condition].or.push(n)}));else if(["field_equal","field_not_equal","field_greater","field_less"].includes(o.operator)){(r={})[jsonLogicOperators[o.operator].op]=[o.value[0],o.value[1]],t[e.condition].push(r)}else if("field_between"==o.operator)t[e.condition]={and:[]},t[e.condition].and.push({">=":[o.value[0],o.value[1]]}),t[e.condition].and.push({"<=":[o.value[0],o.value[2]]});else if("between_dates"==o.operator)t[e.condition]={and:[]},t[e.condition].and.push({">=":[o.field,new moment(o.value[0],i).format(n)]}),t[e.condition].and.push({"<=":[o.field,new moment(o.value[1],i).format(n)]});else if(["equal","not_equal","less","less_or_equal","greater","greater_or_equal"].includes(o.operator)){var r={},l=o.value;["__current_date__","__current_date_time__","__current_time__"].includes(o.field)&&(l=new moment(o.value,i).format(n)),r[jsonLogicOperators[o.operator].op]=[o.field,l],t[e.condition].push(r)}o.rules&&t[e.condition].push(convertRules(o))})),t):(alert("Wrong condition!"),console.log("sdssd"),{})}function rulesToJsonLogic(e){var t=convertRules(e=JSON.parse(JSON.stringify(e).replace('"AND"','"and"').replace('"OR"','"or"')));return t=JSON.parse(JSON.stringify(t).replace('"AND"','"and"').replace('"OR"','"or"'))}function showQualtricsSurveyConfiBuilder(e,t){var o,a=getJson(e);$(".qualtricsConfigBuilderBtn").each((function(){$(this).click((function(){$(".qualtricsSurveyConfig_builder_modal_holder").modal({backdrop:!1}),o&&o.setValue(getJson(e)),$(".qualtricsSurveyConfig_builder_modal_holder").on("hidden.bs.modal",(function(e){})),$(".savequaltricsSurveyConfigBuilder").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){t.getModel().setValue(JSON.stringify(o.getValue(),null,3))}))}))}))}));var i=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/qualtricsSurveyConfig/qualtricsSurveyConfig.json";$.ajax({dataType:"json",url:i,success:function(e){o=new JSONEditor($(".qualtricsSurveyConfig_builder")[0],{theme:"bootstrap4",iconlib:"fontawesome5",ajax:!0,schema:e,startval:a,show_errors:"always",display_required_only:!0})}})}function showActionConfiBuilder(e,t){var o,a=getJson(e);$(".actionConfigBuilderBtn").each((function(){$(this).click((function(){$(".actionConfig_builder_modal_holder").modal({backdrop:!1}),o&&o.setValue(getJson(e)),$(".actionConfig_builder_modal_holder").on("hidden.bs.modal",(function(e){})),$(".saveActionConfigBuilder").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){var e=o.getValue();!e.condition||e.condition instanceof Object||(e.condition=JSON.parse(e.condition)),!e.condition_jquerBuilderJson||e.condition_jquerBuilderJson instanceof Object||(e.condition_jquerBuilderJson=JSON.parse(e.condition_jquerBuilderJson)),t.getModel().setValue(JSON.stringify(e,null,3))}))}))}))}));var i=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/actionConfig/actionConfig.json";$.ajax({dataType:"json",url:i,success:function(e){(o=new JSONEditor($(".actionConfig_builder")[0],{theme:"bootstrap4",iconlib:"fontawesome5",ajax:!0,schema:e,show_errors:"always"})).on("change",(function(){$(".actionConfig_builder").find("select").each((function(){$(this).selectpicker(),$(this).selectpicker("refresh")}))})),getGroupsForActionConfig(o,a,o)}})}function getGroupsForActionConfig(e,t,o){$.post(BASE_PATH+"/request/AjaxDataSource/get_groups",{},(function(a){if(a.success){var i=[];try{i=JSON.parse(a.data)}catch(e){console.log("Error while parsing",a.data)}var n=e.getEditor("root.group").parent;n.original_schema.properties.group.items.enum=i,n.schema.properties.group.items.enum=i,n.removeObjectProperty("group"),delete n.cached_editors.group,n.addObjectProperty("group"),o.setValue(t)}else console.log(a)}),"json")}function showActionConditionBuilder(e,t){$(".actionConfigConditionBuilderBtn").each((function(){$(this).click((function(){$(".action_condition_builder_modal_holder").modal({backdrop:!1}),$(".action_condition_builder_modal_holder").on("hidden.bs.modal",(function(e){})),$(".saveActionConditionBuilder").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){var t=$(".action_condition_builder").queryBuilder("getRules"),o={};try{o=JSON.parse(e.getModel().getValue())}catch(e){}o.condition=rulesToJsonLogic(t),o.condition_jquerBuilderJson=t,e.getModel().setValue(JSON.stringify(o,null,3))}))}))}))})),getGroups(t,e)}
