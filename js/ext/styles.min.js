...
"use strict";function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}var jsonEditorInit="jsonEditorInit",cssEditorInit="cssEditorInit",mdInit="mdInit",simpleMDEEidtorRefreshed=!1;function initTextarea(){initJsonFields(),initMarkdownFields(),initCssFields()}function initJsonFields(){$(".json-mapping").each((function(){var e=this,t=$(this).find(".json-mapping-btn")[0],n=$(this).find(".json")[0],o=$(t).data("name"),r=$('textarea[name*="['+o+']"][name*="[content]"]'),a=$('input[name*="['+o+']"][name*="[meta]"]'),i={};try{i=JSON.parse(a.val())}catch(e){console.log("Meta for "+o+" cannot be parsed")}$(t).data(jsonEditorInit)||($(t).data(jsonEditorInit,!0),require.config({paths:{vs:BASE_PATH+"/js/ext/vs"}}),require(["vs/editor/editor.main"],(function(){var e={value:r.val(),language:"json",automaticLayout:!0,renderLineHighlight:"none"},t=monaco.editor.create(n,e);t.getAction("editor.action.formatDocument").run().then((function(){calcMonacoEditorSize(t,n)})),t.onDidChangeModelContent((function(e){$(r).val(t.getValue()),calcMonacoEditorSize(t,n),$(r).trigger("change")}))})),$(t).off("click").click((function(){var t=$(e).find(".json_mapper_modal_holder")[0],n=$(e).find(".json-mapper-title-field")[0],s=($(e).find(".json-mapper-error-status")[0],$(e).find(".json_mapped_items")[0]),d=$(e).find(".json_tree")[0];$(e).find(".json_tree_path");reloadMappedItems(i,s),$(t).modal({backdrop:!1});var c=$(e).find(".saveJsonMapper")[0];$(c).attr("data-dismiss","modal"),$(n).html(o);try{var l=transformToJsTreeFormat(JSON.parse(r.val()),"").children;$(d).jstree({core:{data:l,themes:{icons:!1}}}),$(d).on("select_node.jstree",(function(e,t){var n=t.node.original;n.text in i||(i[n.text]=""),reloadMappedItems(i,s)}))}catch(e){}$(c).off("click").click((function(){$(a).val(JSON.stringify(i)),$(a).trigger("change")}))})))}))}function removeLastDot(e){return e.endsWith(".")?e.slice(0,-1):e}function transformToJsTreeFormat(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"",n={text:removeLastDot(t),value:removeLastDot(t),children:[]};for(var o in e)if("object"===_typeof(e[o])){var r=transformToJsTreeFormat(e[o],t+o+".");n.children.push(r)}else n.children.push({text:t+o,value:t+o});return n}function check_textarea_locked_after_submit(){$(".selfhelpTextArea").each((function(){$(this).data("locked_after_submit")&&$(this).prop("readonly",!0)}))}function initMarkdownFields(){var e=this,t=$(".style-markdown");Array.from(t).forEach((function(t){if(!$(t).data(mdInit)){$(t).data(mdInit,!0);var n=new EasyMDE({element:t,autoDownloadFontAwesome:!1,spellChecker:!1,autoRefresh:{delay:0},forceSync:!0,toolbar:["bold","italic","heading","quote","unordered-list","ordered-list","link","image","table","preview","guide"],renderingConfig:{singleLineBreaks:!1}});n.codemirror.on("change",(function(){unsavedChanges.push(e)})),n.codemirror.on("cursorActivity",(function(){simpleMDEEidtorRefreshed||(simpleMDEEidtorRefreshed=!0,n.codemirror.refresh())}))}}))}function initCssFields(){$(".css").each((function(){var e=$(this)[0];$(e).data(cssEditorInit)||($(e).data(cssEditorInit,!0),require.config({paths:{vs:BASE_PATH+"/js/ext/vs"}}),require(["vs/editor/editor.main"],(function(){var t={value:$(e).prev().val(),language:"css",automaticLayout:!0,renderLineHighlight:"none"},n=monaco.editor.create(e,t);n.getAction("editor.action.formatDocument").run().then((function(){calcMonacoEditorSize(n,e)})),n.onDidChangeModelContent((function(t){$(e).prev().val(n.getValue()),calcMonacoEditorSize(n,e),$(e).prev().trigger("change")})),cssFormatMonaco(monaco)})))}))}function reloadMappedItems(e,t){$(t).empty();var n=function(n){e.hasOwnProperty(n)&&(r=$("<div/>").addClass("d-flex align-items-center bg-white m-2 p-2 border rounded text-dark"),a=$("<label/>").text(n).addClass("mb-0 pl-2 pr-2 mr-2 font-weight-bold"),(i=$("<input/>").attr("type","text").addClass("rounded border ml-auto border-dark pl-2 pr-2")).val(e[n]),i.change((function(){var t=$(this).val();e[n]=t})),(s=$("<i/>").addClass("far fa-window-close text-danger fa-lg pointer mr-2")).click((function(){var t=n;$(this).parent().remove(),delete e[t]})),r.append(s),r.append(a),r.append(i),$(t).append(r))};for(var o in e){var r,a,i,s;n(o)}}$(document).ready((function(){autosize($("textarea")),check_textarea_locked_after_submit(),initTextarea()}));
