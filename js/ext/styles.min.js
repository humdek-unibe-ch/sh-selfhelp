...
function drawGraph(e,t,n,a,r=(()=>{}),o=!1){let l=e.prev(),i=0,p=[];return t.forEach((function(s,c){if("data_source"in s){let{data_source:u,...f}=s,h="data-filter-"+u.name;l.removeClass("d-none"),i++,o&&window.addEventListener(h,(function(o){console.log("received event: "+h),drawGraph(e,t,n,a,r)})),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:u.name,single_user:u.single_user},(function(t){if(t.success){let o={};o="cb"in u?u.cb(t.data):graphTraceCb(t.data,u),0===c&&Plotly.newPlot(e[0],[],n,a),p.push(deepmerge(f,o)),Plotly.addTraces(e[0],p[c]),r(),i--,0===i&&l.addClass("d-none")}else console.log(t)}),"json")}else 0===c&&Plotly.newPlot(e[0],[],n,a),p.push(s),Plotly.addTraces(e[0],s)})),p}function graphTraceCb(e,t){let n={};for(let a in t.map){graphExpandDotString(n,a,[]);let r=t.map[a],o=a.split(".").reduce((e,t)=>e[t],n);if(Array.isArray(r))r.forEach((function(t){let n=0;"max"===t.op?n=Math.max.apply(Math,e.map((function(e){return e[t.name]}))):"min"===t.op?n=Math.min.apply(Math,e.map((function(e){return e[t.name]}))):"sum"===t.op?n=e.reduce((e,n)=>e+Number(n[t.name]),0):"avg"===t.op&&(n=e.reduce((e,n)=>e+Number(n[t.name]),0),n/=e.length),o.push(n)}));else if("object"==typeof r&&null!==r){let t={},a={};for(let e in r.options)a[e]=graphExpandDotString(n,e,[]);if(e.forEach((function(e){let n=e[r.name];if(!(n in t)){t[n]=o.length,o.push(0);for(let e in r.options)a[e].push(r.options[e][n])}"count"===r.op||"percent"===r.op?o[t[n]]++:"sum"===r.op&&(o[t[n]]+=n)})),"percent"===r.op)for(let t=0;t<o.length;t++)o[t]/=e.length;if("factor"in r)for(let e=0;e<o.length;e++)o[e]*=r.factor;if("offset"in r)for(let e=0;e<o.length;e++)o[e]+=r.offset}else e.forEach((function(e){o.push(e[r])}))}return n}function graphExpandDotString(e,t,n){for(var a=t.split("."),r=e,o=0;o<a.length-1;o++)r[a[o]]={},r=r[a[o]];return r=r[a[a.length-1]]=n}function parseGraphData(e){var t=e.text();try{return JSON.parse(t)}catch(e){return console.log("cannot parse raw data of graph"),console.log(e),null}}$(document).ready(()=>{$("div.graph-base").each((function(){let e=$(this).children("div.graph-plot:first");var t=parseGraphData($(this).children("div.graph-data:first"));if(null===t)return;let n=drawGraph(e,t.traces,t.layout,t.config,()=>{},!0);new ResizeSensor(e,(function(){Plotly.newPlot(e[0],n,t.layout,t.config)}))}))});
