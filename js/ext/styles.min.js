...
"use strict";function initSelectImage(e){var t=$(e).attr("id"),l=$(e).attr("class");iconSelect=new IconSelect(t),selectedValueHolder=document.getElementById("selectValue-"+t.split("-")[1]),$(e).on("changed",(function(e){selectedValueHolder.value=iconSelect.getSelectedValue()}));var a=$(e).attr("data-values");a=JSON.parse(a);var c=[],n=$(selectedValueHolder).val();a.forEach((function(e){e.value==n?c.unshift({iconFilePath:e.text,iconValue:e.value}):c.push({iconFilePath:e.text,iconValue:e.value})})),console.log(c),iconSelect.refresh(c),$(e).addClass(l)}$(document).ready((function(){$(".bootstrapSelect").selectpicker({showTick:!0,allowClear:!0}),$(".selectImage").each((function(e,t){initSelectImage(t)}))}));
