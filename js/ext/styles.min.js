...
function drawGraph(e,t,n,a,o=(()=>{}),r=!1){let l=e.prev(),i=0,c=(new Date).getTime();t.forEach((function(p,s){if("data_source"in p){let{data_source:f,...u}=p,h="data-filter-"+f.name;l.removeClass("d-none"),i++,r&&window.addEventListener(h,(function(r){console.log("received event: "+h),drawGraph(e,t,n,a,o)})),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:f.name,single_user:f.single_user},(function(t){if(t.success){let r={};if(r="cb"in f?f.cb(t.data):graphTraceCb(t.data,f),0===s&&Plotly.newPlot(e[0],[],n,a),console.log(u),console.log(r),Plotly.addTraces(e[0],deepmerge(u,r)),o(),i--,0===i){l.addClass("d-none");let e=new Date;console.log(e.getTime()-c)}}else console.log(t)}),"json")}else 0===s&&Plotly.newPlot(e[0],[],n,a),Plotly.addTraces(e[0],p)}))}function graphTraceCb(e,t){let n={};for(let a in t.map){graphExpandDotString(n,a,[]);let o=t.map[a],r=a.split(".").reduce((e,t)=>e[t],n);if(Array.isArray(o))o.forEach((function(t){let n=0;"max"===t.op?n=Math.max.apply(Math,e.map((function(e){return e[t.name]}))):"min"===t.op?n=Math.min.apply(Math,e.map((function(e){return e[t.name]}))):"sum"===t.op?n=e.reduce((e,n)=>e+Number(n[t.name]),0):"avg"===t.op&&(n=e.reduce((e,n)=>e+Number(n[t.name]),0),n/=e.length),r.push(n)}));else if("object"==typeof o&&null!==o){let t={},a={};for(let e in o.options)a[e]=graphExpandDotString(n,e,[]);if(e.forEach((function(e){let n=e[o.name];if(!(n in t)){t[n]=r.length,r.push(0);for(let e in o.options)a[e].push(o.options[e][n])}"count"===o.op||"percent"===o.op?r[t[n]]++:"sum"===o.op&&(r[t[n]]+=n)})),"percent"===o.op)for(let t=0;t<r.length;t++)r[t]/=e.length;if("factor"in o)for(let e=0;e<r.length;e++)r[e]*=o.factor;if("offset"in o)for(let e=0;e<r.length;e++)r[e]+=o.offset}else e.forEach((function(e){r.push(e[o])}))}return n}function graphExpandDotString(e,t,n){for(var a=t.split("."),o=e,r=0;r<a.length-1;r++)o[a[r]]={},o=o[a[r]];return o=o[a[a.length-1]]=n}function parseGraphData(e){var t=e.text();try{return JSON.parse(t)}catch(e){return console.log("cannot parse raw data of graph"),console.log(e),null}}$(document).ready(()=>{$("div.graph-base").each((function(){let e=$(this).children("div.graph-plot");var t=parseGraphData($(this).children("div.graph-data:first"));null!==t&&drawGraph(e,t.traces,t.layout,t.config,()=>{},!0)}))});
