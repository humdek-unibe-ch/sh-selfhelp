...
"use strict";function _toConsumableArray(e){return _arrayWithoutHoles(e)||_iterableToArray(e)||_unsupportedIterableToArray(e)||_nonIterableSpread()}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function _unsupportedIterableToArray(e,r){if(e){if("string"==typeof e)return _arrayLikeToArray(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);return"Object"===t&&e.constructor&&(t=e.constructor.name),"Map"===t||"Set"===t?Array.from(e):"Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t)?_arrayLikeToArray(e,r):void 0}}function _iterableToArray(e){if("undefined"!=typeof Symbol&&Symbol.iterator in Object(e))return Array.from(e)}function _arrayWithoutHoles(e){if(Array.isArray(e))return _arrayLikeToArray(e)}function _arrayLikeToArray(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,n=new Array(r);t<r;t++)n[t]=e[t];return n}function asyncGeneratorStep(e,r,t,n,o,a,s){try{var i=e[a](s),u=i.value}catch(e){return void t(e)}i.done?r(u):Promise.resolve(u).then(n,o)}function _asyncToGenerator(e){return function(){var r=this,t=arguments;return new Promise((function(n,o){var a=e.apply(r,t);function s(e){asyncGeneratorStep(a,n,o,s,i,"next",e)}function i(e){asyncGeneratorStep(a,n,o,s,i,"throw",e)}s(void 0)}))}}var editor=null;function createJSONEditor(e){editor&&editor.destroy(),(editor=new JSONEditor($("#jobConfig")[0],{theme:"bootstrap4",iconlib:"fontawesome5",ajax:!0,schema:e,show_errors:"always"})).on("ready",(function(){crrValue=!1;try{crrValue=JSON.parse($("#jobConfigValue").val())}catch(e){}crrValue&&editor.editors.root.setValue(crrValue,!0),editor.on("change",(function(){$("#jobConfig").find("select").each((function(){$(this).is('[name*="attachments"]')&&$(this).data("live-search","true"),$(this).selectpicker(),$(this).selectpicker("refresh")})),$("#jobConfigValue").val(JSON.stringify(editor.getValue()))})),$("#jobConfig").hasClass("view-select")&&editor.disable()}))}function loadJobConfig(){if($("#jobConfig").length>0){var e=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/jobConfig/jobConfig.json";$.ajax({dataType:"json",url:e,success:function(e){createJSONEditor(e),setDynamicEnums()}})}}function prepareEnumSource(e){for(var r in enumValues=[],e)enumValues.push({value:r,text:e[r]});return res=[],res.push({source:enumValues,title:"{{item.text}}",value:"{{item.value}}"}),res}function get_forms(){var e={};return $('select[name="id_forms"]').find("option").each((function(){this.value&&(e[this.value]=this.text)})),e}function get_time_intervals_text(){for(var e={1:"1st",2:"2nd",3:"3rd"},r=4;r<=20;r++)e[r]=r+"th";return e}function getAssets(e){return _getAssets.apply(this,arguments)}function _getAssets(){return(_getAssets=_asyncToGenerator(regeneratorRuntime.mark((function e(r){var t;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return t=[],jQuery.ajax({url:BASE_PATH+"/request/AjaxDataSource/get_assets",async:!1,cache:!1,type:"post",data:{filter:r},dataType:"json",success:function(e){if(e.success)try{t=JSON.parse(e.data)}catch(r){console.log("Error while parsing JSON",e.data)}else console.log(e)}}),e.abrupt("return",t);case 3:case"end":return e.stop()}}),e)})))).apply(this,arguments)}function setDynamicEnums(){return _setDynamicEnums.apply(this,arguments)}function _setDynamicEnums(){return(_setDynamicEnums=_asyncToGenerator(regeneratorRuntime.mark((function e(){var r,t,n,o;return regeneratorRuntime.wrap((function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,getGroups();case 2:return r=e.sent,editor.schema.definitions.job_ref.properties.job_add_remove_groups.items.enum=r,editor.schema.properties.selected_target_groups.items.enum=_toConsumableArray(r),e.next=7,getLookups("actionScheduleTypes");case 7:return t=e.sent,e.next=10,getLookups("weekdays");case 10:return n=e.sent,e.next=13,getAssets("");case 13:o=e.sent,editor.schema.definitions.schedule_time_ref.properties.job_schedule_types.enumSource=prepareEnumSource(t),editor.schema.definitions.schedule_time_ref.properties.send_on_day.enumSource=prepareEnumSource(n),editor.schema.definitions.schedule_time_ref.properties.send_on.enumSource=prepareEnumSource(get_time_intervals_text()),editor.schema.definitions.job_ref.properties.reminder_form_id.enumSource=prepareEnumSource(get_forms()),editor.schema.definitions.notification_ref.properties.attachments.items.enum=o,createJSONEditor(editor.schema);case 20:case"end":return e.stop()}}),e)})))).apply(this,arguments)}$(document).ready((function(){loadJobConfig()}));
