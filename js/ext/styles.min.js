...
"use strict";var dataConfigInitCalls={},dataConfigInit="dataConfigInit";function initDataConfigBuilder(){$(".dataConfigBuilderBtn").each((function(){var e=$("textarea[name*='data_config']")[0];$(this).off("click").click((function(){$(".data_config_builder_modal_holder").modal({backdrop:!1}),$(".saveDataConfig").each((function(){$(this).attr("data-dismiss","modal"),$(this).click((function(){var t=JSON.stringify(editor.getValue(),null,3);"[]"==t&&(t=""),$(e).val(t),$(e).trigger("change")}))}))}));var t=$(".data_config_builder")[0];if(!$(t).data(dataConfigInit)){$(t).data(dataConfigInit,!0);var a=window.location.protocol+"//"+window.location.host+BASE_PATH+"/schemas/dataConfig/dataConfig.json",i=null;try{i=JSON.parse($(e).val())}catch(e){i=null}$.ajax({dataType:"json",url:a,success:function(e){var a=new JSONEditor(t,{theme:"bootstrap4",input_size:"small",custom_forms:!1,object_indent:!1,table_border:!0,table_zebrastyle:!0,tooltip:"bootstrap",iconlib:"fontawesome5",ajax:!0,schema:e,startval:i,show_errors:"always",display_required_only:!0,compact:!0});for(var l in a.off("change").on("change",(function(){for(var e in a.editors)if(a.editors.hasOwnProperty(e)&&"root"!==e&&a.watchlist&&!a.watchlist[e]&&(e.includes("table")||e.includes("type")||e.includes("field_name"))){if(e.includes("type"))getTableNames(a.getEditor(e).getValue(),a,e.replace("type","table"));else if(e.includes("field_name")){var t=e.split("."),i=t[0]+"."+t[1];getTableFieldNames(this.getEditor(i+".type").getValue(),this.getEditor(i+".table").getValue(),this,e,!0)}a.watch(e,dataConfigWatcherCallback.bind(a,e))}})),a.editors)if(a.editors.hasOwnProperty(l)&&"root"!==l)if(l.includes("type")){var o=l.replace("type","table");dataConfigInitCalls[o]=!1,getTableNames(a.getEditor(l).getValue(),a,l.replace("type","table"),a)}else if(l.includes("table")&&a.getEditor(l)&&a.getEditor(l).getValue()){o=l.replace("type","table");dataConfigInitCalls[o]=!1,getTableFieldNames(a.getEditor(l.replace("table","type")).getValue(),a.getEditor(l).getValue(),a,l.replace("table","fields"),!1,a)}}})}}))}$(document).ready((function(){initDataConfigBuilder()}));var dataConfigWatcherCallback=function(e){e.includes("type")&&this.getEditor(e)&&this.getEditor(e).getValue()?getTableNames(this.getEditor(e).getValue(),this,e.replace("type","table")):e.includes("table")&&this.getEditor(e)&&this.getEditor(e).getValue()&&getTableFieldNames(this.getEditor(e.replace("table","type")).getValue(),this.getEditor(e).getValue(),this,e.replace("table","fields"),!1)};function checkAllDataConfigInitCalls(e){var t=!0;for(var a in dataConfigInitCalls)t=dataConfigInitCalls[a]&&t;if(t)for(var i in e.editors)e.editors.hasOwnProperty(i)&&"root"!==i&&(i.includes("table")||i.includes("type")||i.includes("field_name"))&&e.watch(i,dataConfigWatcherCallback.bind(e,i))}function getTableNames(e,t,a,i){$.post(BASE_PATH+"/request/AjaxDataSource/get_table_names",{type:e},(function(e){if(e.success){var l=[];try{l=JSON.parse(e.data)}catch(t){console.log("Error while parsing",e.data)}var o=t.getEditor(a).getValue().valueOf(),r=t.getEditor(a).parent;r.original_schema.properties.table.enum=l,r.schema.properties.table.enum=l,r.removeObjectProperty("table"),delete r.cached_editors.table,r.addObjectProperty("table"),t.getEditor(a).setValue(o)}else console.log(e);i&&(dataConfigInitCalls[a]=!0,checkAllDataConfigInitCalls(i))}),"json")}function getTableFieldNames(e,t,a,i,l,o){$.post(BASE_PATH+"/request/AjaxDataSource/get_table_fields",{type:e,name:t},(function(e){if(e.success){var t=[];try{t=JSON.parse(e.data)}catch(t){console.log("Error while parsing",e.data)}if(l)(n=a.getEditor(i).parent).original_schema.properties.field_name.enum=t,n.schema.properties.field_name.enum=t,n.removeObjectProperty("field_name"),delete n.cached_editors.field_name,n.addObjectProperty("field_name");else for(var r=0;r<a.getEditor(i).rows.length;r++){var n,s=a.getEditor(i+"."+r+".field_name").getValue().valueOf();(n=a.getEditor(i+"."+r+".field_name").parent).original_schema.properties.field_name.enum=t,n.schema.properties.field_name.enum=t,n.removeObjectProperty("field_name"),delete n.cached_editors.field_name,n.addObjectProperty("field_name"),a.getEditor(i+"."+r+".field_name").setValue(s)}}else console.log(e);o&&(dataConfigInitCalls[i]=!0,checkAllDataConfigInitCalls(o))}),"json")}
