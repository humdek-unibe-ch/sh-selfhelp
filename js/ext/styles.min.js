...
"use strict";$(document).ready((function(){var t=$(".chat"),h=document.body.scrollHeight,i=t.height();t.height(i-(h-$(window).height())),t.scrollTop(h),$(window).resize((function(){t.height(i-(h-$(this).height())),t.scrollTop(h)}))}));
