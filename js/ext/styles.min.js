...
function drawGraph(e,t,n,r,a=(()=>{}),o=!1){let l=e.prev(),i=0,c=[],s=[];return t.forEach((function(h,f){if("data_source"in h){let{data_source:p,...u}=h,d="data-filter-"+p.name;l.removeClass("d-none"),i++,o&&!s.includes(d)&&(s.push(d),window.addEventListener(d,(function(o){console.log("received event: "+d),drawGraph(e,t,n,r,a)}))),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:p.name,single_user:p.single_user},(function(t){if(t.success){let o={};o="cb"in p?p.cb(t.data):graphTraceCb(t.data,p),0===f&&Plotly.newPlot(e[0],[],n,r),c.push(deepmerge(u,o)),Plotly.addTraces(e[0],c[f]),a(),i--,0===i&&l.addClass("d-none")}else console.log(t)}),"json")}else 0===f&&Plotly.newPlot(e[0],[],n,r),c.push(h),Plotly.addTraces(e[0],h)})),c}function graphTraceCb(e,t){let n={};for(let r in t.map){graphExpandDotString(n,r,[]);let a=t.map[r],o=graphExpandDotString(n,r,[]);Array.isArray(a)?a.forEach((function(t){let n=0;"max"===t.op?n=Math.max.apply(Math,e.map((function(e){return e[t.name]}))):"min"===t.op?n=Math.min.apply(Math,e.map((function(e){return e[t.name]}))):"sum"===t.op?n=e.reduce((e,n)=>e+Number(n[t.name]),0):"avg"===t.op&&(n=e.reduce((e,n)=>e+Number(n[t.name]),0),n/=e.length),o.push(n)})):"object"==typeof a&&null!==a?graphTraceCbData(e,n,o,a.name,a.ignore,a.options,a.order,a.maps,a.children):e.forEach((function(e){o.push(e[a])}))}return n}function graphTraceCbData(e,t,n,r,a,o,l,i={},c={}){let s={},h={};for(let e in i)h[e]=graphExpandDotString(t,e,[]);let f=!1,p=0;if(e.forEach((function(e){let t=e[r];if(!a||!a.includes(t)){if(!(t in s)){f=!0,s[t]=n.length,n.push(0);for(let e in i)h[e].push(i[e][t])}"count"===o.op||"percent"===o.op?n[s[t]]++:"sum"===o.op?n[s[t]]+=t:"val"===o.op?n[s[t]]=Number(t):"idx"===o.op&&f&&(n[s[t]]=p++,f=!1)}})),"percent"===o.op)for(let t=0;t<n.length;t++)n[t]/=e.length;if("range"in o&&"min"in o.range&&"max"in o.range){let e=Math.max(...n),t=Math.min(...n);for(let r=0;r<n.length;r++)n[r]=(n[r]-t)*(o.range.max-o.range.min)/(e-t)+o.range.min}if("factor"in o)for(let e=0;e<n.length;e++)n[e]*=o.factor;if("offset"in o)for(let e=0;e<n.length;e++)n[e]+=o.offset;if("round"in o)for(let e=0;e<n.length;e++){let t=Math.pow(10,o.round);n[e]=Math.round((n[e]+Number.EPSILON)*t)/t}let u=null;if(Array.isArray(l)){if("idx"!==o.op){let e=n.slice();for(let t=0;t<e.length;t++)n[t]=e[l[t]]}}else if(l&&("asc"===l?u=sortWithIndices(n):"desc"===l&&(u=sortWithIndices(n,!1)),u))for(let e in h){let t=h[e].slice();for(let n=0;n<t.length;n++)h[e][n]=t[u[n]]}if("suffix"in o)for(let e=0;e<n.length;e++)n[e]=`${n[e]}${o.suffix}`;for(child_key in c){graphTraceCbData(e,t,graphExpandDotString(t,child_key,[]),r,a,c[child_key],u)}}function sortWithIndices(e,t=!0){let n=[],r=t?1:-1;for(var a=0;a<e.length;a++)e[a]=[e[a],a];e.sort((function(e,t){return e[0]<t[0]?-1*r:1*r}));for(var o=0;o<e.length;o++)n.push(e[o][1]),e[o]=e[o][0];return n}function graphExpandDotString(e,t,n){for(var r=t.split("."),a=e,o=0;o<r.length-1;o++)r[o]in a||(a[r[o]]={}),a=a[r[o]];return a=a[r[r.length-1]]=n}function parseGraphData(e){var t=e.text();try{return JSON.parse(t)}catch(e){return console.log("cannot parse raw data of graph"),console.log(e),null}}$(document).ready(()=>{$("div.graph-base").each((function(){let e=$(this).children("div.graph-plot:first");var t=parseGraphData($(this).children("div.graph-data:first"));if(null===t)return;let n=drawGraph(e,t.traces,t.layout,t.config,()=>{},!0);new ResizeSensor(e,(function(){n.length===t.traces.length&&Plotly.newPlot(e[0],n,t.layout,t.config)}))}))});
