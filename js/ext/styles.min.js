...
function position_slider_legend(){$(".slider-legend").each(function(){var e=$(this).prev().outerWidth(),i=$(this).children().length,t=e/(i-1);$(this).children().each(function(n){var s=0;0==n?($(this).parent().outerHeight($(this).outerHeight()),s=0):s=n==i-1?e-$(this).outerWidth():t*n-$(this).outerWidth()/2,$(this).css({marginLeft:s})})})}$(document).ready(function(){new ResizeSensor(jQuery(".selfhelp-slider"),function(){position_slider_legend()}),position_slider_legend()});
