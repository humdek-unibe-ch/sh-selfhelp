...
function drawGraph(a,e,t,r,n=(()=>{}),o=!1){e.forEach(function(c,l){if("data_source"in c){let{data_source:s,...i}=c,d=`data-filter-${s.name}`;o&&window.addEventListener(d,function(o){console.log("received event: "+d),drawGraph(a,e,t,r,n)}),$.post(BASE_PATH+"/request/AjaxDataSource/get_data_table",{name:s.name,single_user:s.single_user},function(e){if(e.success){let o={};o="cb"in s?s.cb(e.data):trace_cb(e.data,s),0===l&&Plotly.newPlot(a[0],[],t,r),Plotly.addTraces(a[0],{...i,...o}),n()}else console.log(e)},"json")}else 0===l&&Plotly.newPlot(a[0],[],t,r),Plotly.addTraces(a[0],c)})}function trace_cb(a,e){let t={};for(let r in e.map)t[r]=[],a.forEach(function(a){t[r].push(a[e.map[r]])});return t}function parseGraphData(a){var e=a.text();try{return JSON.parse(e)}catch(a){return console.log("cannot parse raw data of graph"),console.log(a),null}}$(document).ready(()=>{$("div.graph-base").each(function(){let a=$(this).children("div.graph-plot");var e=parseGraphData($(this).children("div.graph-data:first"));null!==e&&drawGraph(a,e.traces,e.layout,e.config)})});
