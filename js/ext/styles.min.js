...
"use strict";function setKeyboardKeys(){$(document).keydown((function(t){switch(t.keyCode){case 37:$(".book-turnjs").turn("previous");break;case 39:$(".book-turnjs").turn("next")}}))}function updateDepth(t,e){var n=t.turn("page"),s=t.turn("pages"),r=16*Math.min(1,2*n/s);(e=e||n)>3?$(".book-turnjs .p2 .depth").css({width:r,left:20-r}):$(".book-turnjs .p2 .depth").css({width:0}),r=16*Math.min(1,2*(s-n)/s),e<s-3?$(".book-turnjs .secondLast .depth").css({width:r,right:20-r}):$(".book-turnjs .secondLast .depth").css({width:0})}function getViewNumber(t,e){return parseInt((e||t.turn("page"))/2+1,10)}function setSlider(){$("#slider").slider({min:1,max:100,stop:function(){$(".book-turnjs").turn("page",Math.max(1,2*$(this).slider("value")-2))}})}$(document).ready((function(){$(".book-turnjs").each((function(){var t=$(this).data("config");t&&'""'!=t||(t={});var e=!1;t&&t.slider?(e=!0,setSlider()):$("#slider-bar").addClass("d-none"),t.when={turning:function(t,e,n){window.location.hash="#page-"+e;var s=$(this),r=s.turn("page"),i=s.turn("pages");if(r>3&&r<i-3){if(1==e)return s.turn("page",2).turn("stop").turn("page",e),void t.preventDefault();if(e==i)return s.turn("page",i-1).turn("stop").turn("page",e),void t.preventDefault()}else if(e>3&&e<i-3){if(1==r)return s.turn("page",2).turn("stop").turn("page",e),void t.preventDefault();if(r==i)return s.turn("page",i-1).turn("stop").turn("page",e),void t.preventDefault()}updateDepth(s,e),e>=2?$(".book-turnjs .p2").addClass("fixed"):$(".book-turnjs .p2").removeClass("fixed"),e<s.turn("pages")?$(".book-turnjs .secondLast").addClass("fixed"):$(".book-turnjs .secondLast").removeClass("fixed")},turned:function(t,n,s){var r=$(this);2!=n&&3!=n||r.turn("peel","br"),updateDepth(r),e&&$("#slider").slider("value",getViewNumber(r,n)),r.turn("center")},end:function(t,n){var s=$(this);updateDepth(s),setTimeout((function(){e&&$("#slider").slider("value",getViewNumber(s))}),1)},missing:function(t,e){}},$(this).turn(t);var n=window.location.hash.substring(1);n&&$(this).turn("page",n.replace("page-","")),e&&$("#slider").slider("option","max",$(this).turn("pages")/2+1),$(this).addClass("animated"),$("#canvas").css({visibility:""})})),setKeyboardKeys()})),$("#canvas").css({visibility:"hidden"});
...
"use strict";function formSubmitEvent(){$("form").on("submit",(function(t){if(1==$(this).find('input[name="ajax"]').val()){var e=1==$(this).find('input[name="is_log"]').val(),n=$(this).find('input[name="redirect_at_end"]').val();t.preventDefault(),$(".alert-danger").remove(),$(".alert-success").remove();var r=[];$(this).find(":submit").each((function(){var t=$(this).html();r.push({btn:this,origLabel:t}),$(this).html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"> </span> '+t)}));var i=this;$.ajax({type:"post",url:$("form").attr("action"),data:$("form").serialize(),success:function(t){var a=(new DOMParser).parseFromString(t,"text/html");$(a).find(".alert-success").each((function(){$(this).insertBefore($("form"))})),$(a).find(".alert-danger").each((function(){$(this).insertBefore($("form"))})),e&&$(i)[0].reset(),r.forEach((function(t){$(t.btn).html(t.origLabel)})),n&&(window.location=n)}})}}))}$(document).ready((function(){formSubmitEvent()}));
