...
class CallbackQualtrics extends BaseCallback
{
    ...
    {
        $this->db->insert("qualtricsSurveysResponses", array(
            "id_users" => $uid,
            ...
            "id_qualtricsProjectStageTriggerType" => $this->db->query_db_first(
                'SELECT id FROM lookups WHERE lookup_value = :lv',
                array(":lv" => $data[ModuleQualtricsProjectModel::QUALTRICS_TRIGGER_TYPE_VARIABLE])
            )['id'],
