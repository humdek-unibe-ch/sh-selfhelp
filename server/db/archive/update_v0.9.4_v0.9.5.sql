...
INSERT INTO `fields` (`id`, `name`, `id_type`, `display`) VALUES (NULL, 'label_date_time', '0000000001', '1');
INSERT INTO `styles_fields` (`id_styles`, `id_fields`, `default_value`) VALUES ('0000000039', '0000000053', NULL);
INSERT INTO `styles_fields` (`id_styles`, `id_fields`, `default_value`) VALUES ('0000000039', '0000000087', '0');
INSERT INTO `styles_fields` (`id_styles`, `id_fields`, `default_value`) VALUES ('0000000039', '0000000088', NULL);

-- update form styles
UPDATE `styles` SET `name` = 'formUserInput' WHERE `styles`.`id` = 0000000036;
DELETE FROM `styles` WHERE `styles`.`id` = 0000000037;
INSERT INTO `styles_fields` (`id_styles`, `id_fields`, `default_value`) VALUES ('0000000036', '0000000087', '0');
