...
INSERT INTO `chatRoom` (`id`, `name`) VALUES (NULL, 'root', 'The main room where every user is part of');
...
-- chat admin select
INSERT INTO `pages` (`id`, `keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`) VALUES (NULL, 'chatAdminSelect', '/admin/chat/[i:rid]?', 'GET', '0000000002', NULL, '0000000009', '0', '35', NULL, '0000000004');
...
-- chat admin insert
INSERT INTO `pages` (`id`, `keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`) VALUES (NULL, 'chatAdminInsert', '/admin/chat_insert/', 'GET|POST|PUT', '0000000002', NULL, '0000000009', '0', NULL, NULL, '0000000004');
...
-- chat admin delete
INSERT INTO `pages` (`id`, `keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`) VALUES (NULL, 'chatAdminDelete', '/admin/chat_delete/[i:rid]', 'GET|POST|DELETE', '0000000002', NULL, '0000000009', '0', NULL, NULL, '0000000004');
...
-- chat admin update
INSERT INTO `pages` (`id`, `keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`) VALUES (NULL, 'chatAdminUpdate', '/admin/chat_update/[i:rid]/[add_user|rm_user:mode]/[i:did]?', 'GET|POST|PATCH', '0000000002', NULL, '0000000009', '0', NULL, NULL, '0000000004');
