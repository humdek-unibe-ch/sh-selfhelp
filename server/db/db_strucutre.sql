...
--
-- Host: 127.0.0.1    Database: sb_test
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=994 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=6038 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3013 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2118 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `llmConversations`
--

DROP TABLE IF EXISTS `llmConversations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `llmMessages`
--

DROP TABLE IF EXISTS `llmMessages`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1299 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `qualtricsSurveys` (
  ...
  `id_users_last_sync` int(10) unsigned zerofill DEFAULT NULL,
  `save_data` int DEFAULT '0',
  `save_labels_data` int DEFAULT '0',
  PRIMARY KEY (`id`),
  ...
  KEY `qualtricsSurveys_fk_id_users_last_sync` (`id_users_last_sync`),
  KEY `qualtricsSurveys_fk_id_qualtricsProjects` (`id_qualtricsProjects`),
  CONSTRAINT `qualtricsSurveys_fk_id_qualtricsProjects` FOREIGN KEY (`id_qualtricsProjects`) REFERENCES `qualtricsProjects` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `qualtricsSurveys_fk_id_users_last_sync` FOREIGN KEY (`id_users_last_sync`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `r_scripts`
--

DROP TABLE IF EXISTS `r_scripts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `r_scripts` (
  `id` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=9934 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2247 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tasks` (
  ...
  `config` longtext,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8524 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=7322 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=191695 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `id_userTypes` int(10) unsigned zerofill NOT NULL DEFAULT '0000000085',
  PRIMARY KEY (`id`),
...
CREATE TABLE `users_2fa_codes` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_users` (`id_users`),
  CONSTRAINT `users_2fa_codes_ibfk_1` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
/*!50001 CREATE VIEW `view_qualtricssurveys` AS SELECT 
 ...
 1 AS `edited_on`,
 1 AS `config`,
 1 AS `id_qualtricsProjects`,
 1 AS `id_users_last_sync`,
 1 AS `save_data`,
 1 AS `save_labels_data`,
 1 AS `survey_type`,
...
--
-- Temporary view structure for view `view_surveys`
--

DROP TABLE IF EXISTS `view_surveys`;
/*!50001 DROP VIEW IF EXISTS `view_surveys`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `view_surveys` AS SELECT 
 1 AS `id`,
 1 AS `survey_generated_id`,
 1 AS `created_at`,
 1 AS `updated_at`,
 1 AS `config`,
 1 AS `survey_name`,
...
--
-- Dumping routines for database 'sb_test'
--
...
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` FUNCTION `get_form_fields_helper`(form_id_param INT) RETURNS text CHARSET utf8mb3
    READS SQL DATA
    DETERMINISTIC
BEGIN 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` FUNCTION `get_page_fields_helper`(page_id INT, language_id INT, default_language_id INT) RETURNS text CHARSET utf8mb3
    READS SQL DATA
    DETERMINISTIC
BEGIN 
    SET @@group_concat_max_len = 32000000;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` FUNCTION `get_sections_fields_helper`(section_id INT, language_id INT, gender_id INT) RETURNS text CHARSET utf8mb3
    READS SQL DATA
    DETERMINISTIC
BEGIN 
	SET @@group_concat_max_len = 32000000;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `add_foreign_key`(param_table VARCHAR(100), fk_name VARCHAR(100), fk_column VARCHAR(100), fk_references VARCHAR(200))
BEGIN	
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `add_index`(param_table VARCHAR(100), param_index_name VARCHAR(100), param_index_column VARCHAR(1000))
BEGIN	
    SET @sqlstmt = (SELECT IF(
		(
			SELECT COUNT(*)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `add_table_column`(
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `add_unique_key`(param_table VARCHAR(100), param_index VARCHAR(100), param_column VARCHAR(100))
BEGIN
    IF NOT EXISTS 
	(
		SELECT NULL 
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `drop_foreign_key`(param_table VARCHAR(100), fk_name VARCHAR(100))
BEGIN	
    SET @sqlstmt = (SELECT IF(
		(
			SELECT COUNT(*)
...
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `drop_index`(param_table VARCHAR(100), param_index_name VARCHAR(100))
BEGIN	
	SET @sqlstmt = (SELECT IF(
		(
			SELECT COUNT(*)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `drop_table_column`(param_table VARCHAR(100), param_column VARCHAR(100))
BEGIN	
    SET @sqlstmt = (SELECT IF(
		(
			SELECT COUNT(*) 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_all_sections_in_page` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_all_sections_in_page`(param_page_id INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_dataTable_with_filter`( 
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_group_acl`( param_group_id INT, param_page_id INT )
BEGIN

    SELECT acl.id_groups, acl.id_pages, 
	CASE
		WHEN p.id_type = 4 then 1 
		ELSE acl.acl_select
	END AS acl_select, 
	...
	p.id_type
	FROM acl_groups acl
	INNER JOIN pages p ON (acl.id_pages = p.id or (p.id_type = 4 and acl.id_pages = null)) 
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_navigation`( param_locale VARCHAR(10) )
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_page_fields`( page_id INT, language_id INT, default_language_id INT, filter_param VARCHAR(1000), order_param VARCHAR(1000))
    READS SQL DATA
    DETERMINISTIC
BEGIN  
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_sections_fields`( section_id INT, language_id INT, gender_id INT, filter_param VARCHAR(1000), order_param VARCHAR(1000))
    READS SQL DATA
    DETERMINISTIC
BEGIN  
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `get_user_acl`( param_user_id INT, param_page_id INT )
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `rename_table`(param_old_table_name VARCHAR(100), param_new_table_name VARCHAR(100))
BEGIN	
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `rename_table_column`(param_table VARCHAR(100), param_old_column_name VARCHAR(100), param_new_column_name VARCHAR(100))
BEGIN	
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`bashev`@`%` PROCEDURE `update_formId_reminders`()
BEGIN
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`bashev`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `view_qualtricssurveys` AS select `s`.`id` AS `id`,`s`.`name` AS `name`,`s`.`description` AS `description`,`s`.`qualtrics_survey_id` AS `qualtrics_survey_id`,`s`.`id_qualtricsSurveyTypes` AS `id_qualtricsSurveyTypes`,`s`.`group_variable` AS `group_variable`,`s`.`created_on` AS `created_on`,`s`.`edited_on` AS `edited_on`,`s`.`config` AS `config`,`s`.`id_qualtricsProjects` AS `id_qualtricsProjects`,`s`.`id_users_last_sync` AS `id_users_last_sync`,`s`.`save_data` AS `save_data`,`s`.`save_labels_data` AS `save_labels_data`,`typ`.`lookup_value` AS `survey_type`,`typ`.`lookup_code` AS `survey_type_code`,`p`.`name` AS `project_name`,`p`.`api_library_id` AS `api_library_id`,`p`.`api_mailing_group_id` AS `api_mailing_group_id` from ((`qualtricssurveys` `s` join `qualtricsprojects` `p` on((`s`.`id_qualtricsProjects` = `p`.`id`))) join `lookups` `typ` on((`typ`.`id` = `s`.`id_qualtricsSurveyTypes`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `view_surveys`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`bashev`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `view_surveys` AS select `surveys`.`id` AS `id`,`surveys`.`survey_generated_id` AS `survey_generated_id`,`surveys`.`created_at` AS `created_at`,`surveys`.`updated_at` AS `updated_at`,json_set(`surveys`.`config`,'$.survey_generated_id',`surveys`.`survey_generated_id`) AS `config`,json_unquote(if(json_contains_path(`surveys`.`config`,'one','$.title.default'),json_extract(`surveys`.`config`,'$.title.default'),json_extract(`surveys`.`config`,'$.title'))) AS `survey_name`,`surveys`.`published` AS `published`,`surveys`.`published_at` AS `published_at` from `surveys` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-12-04  9:36:57
