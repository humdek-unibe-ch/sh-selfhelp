...
(0000000076, 'has_hierarchy', 0000000003, 0),
...
--
ALTER TABLE `fields`
  MODIFY `id` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
--
