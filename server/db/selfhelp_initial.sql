...
(0000000179, 'locked_after_submit', 0000000003, 0),
...
(0000000066, 'book', 0000000001, 0000000004, 'Wrap other styles and later show them as pages. It is based on `turn.js`'),
(0000000067, 'refContainer', 0000000001, 0000000004, 'Wrap other styles that later can be used in different place. It can be used for creating resusable blocks.'),
...
(0000000016, 0000000179, NULL, 'If selected and if the field is used in a form that is not `is_log`, once the value is set, the field will not be able to be edited anymore.', 0, 0),
...
(0000000022, 0000000179, NULL, 'If selected and if the field is used in a form that is not `is_log`, once the value is set, the field will not be able to be edited anymore.', 0, 0),
...
(0000000023, 0000000179, NULL, 'If selected and if the field is used in a form that is not `is_log`, once the value is set, the field will not be able to be edited anymore.', 0, 0),
...
(0000000026, 0000000179, NULL, 'If selected and if the field is used in a form that is not `is_log`, once the value is set, the field will not be able to be edited anymore.', 0, 0),
...
(0000000038, 0000000179, NULL, 'If selected and if the field is used in a form that is not `is_log`, once the value is set, the field will not be able to be edited anymore.', 0, 0),
...
(0000000066, 0000000006, '0', 'Children that can be added to the style. Each child will be loaded as a page', 0, 0),
(0000000066, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0, 0),
(0000000066, 0000000073, NULL, 'Label for button back if in the book config propert `showButtons` is set to `true`', 0, 0),
(0000000066, 0000000074, NULL, 'Label for button next if in the book config propert `showButtons` is set to `true`', 0, 0),
(0000000066, 0000000124, NULL, 'Define the configuration of the book. Refer to the documentation of [turn.js](http://www.turnjs.com/turnjs4-api-docs.pdf) for more information', 0, 0),
(0000000066, 0000000182, NULL, 'Allows to assign `mobile` CSS classes to the root item of the style.', 0, 0),
(0000000067, 0000000006, '0', 'Children that can be added to the style and later used in multiple places', 0, 0),
