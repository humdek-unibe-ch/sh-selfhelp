...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 20, 2021 at 09:38 AM
...
(0000000001, 0000000001, NULL, 'The placeholder in the email input field.', 0),
(0000000001, 0000000002, NULL, 'The placeholder in the password input field.', 0),
(0000000001, 0000000003, NULL, 'The text on the login button.', 0),
(0000000001, 0000000004, NULL, 'The name of the password reset link.', 0),
(0000000001, 0000000005, NULL, 'This text is displayed in a danger-alert-box whenever the login fails.', 0),
(0000000001, 0000000007, NULL, 'The text displayed in the login card header.', 0),
(0000000001, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000001, 0000000028, 'dark', 'This allows to choose the colour scheme for the login form.', 0),
(0000000002, 0000000005, NULL, 'This text will be displayed if a user was unable to change his settings.', 0),
(0000000002, 0000000006, NULL, 'This field holds the main structure of the profile page content. Styles were used to construct this in order to keep the layout consistent. In order to change specific aspects of the profile page, navigate through the children and make changes where needed.', 0),
(0000000002, 0000000019, NULL, 'This text will be displayed if a user wants to delete his or her account but the operation failed.', 0),
(0000000002, 0000000020, NULL, 'This text will be displayed upon successful deletion of a user account.', 0),
(0000000002, 0000000035, NULL, 'This text will be displayed upon successful change of user settings.', 0),
(0000000003, 0000000006, NULL, 'The child sections to be added to the `container` body. This can hold any style.', 0),
(0000000003, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000003, 0000000029, '0', 'Select for a full width container, spanning the entire width of the viewport.', 0),
...
(0000000004, 0000000006, NULL, 'The child sections to be added to the `jumbotron` body. This can hold any style.', 0),
(0000000004, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000005, 0000000021, '1', 'The HTML heading level (1-6)', 0),
(0000000005, 0000000022, NULL, 'The text to be rendered as heading.', 0),
(0000000005, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000006, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000006, 0000000025, NULL, 'Use <a href=\"https://en.wikipedia.org/wiki/Markdown\" target=\"_blank\">markdown</a> syntax here.', 0),
(0000000006, 0000000145, '', 'In this ***JSON*** field we can configure a data retrieve params from the DB, either `static` or `dynamic` data. Example: \n ```\n [\n	{\n		\"type\": \"static|dynamic\",\n		\"table\": \"table_name | #url_param1\",\n        \"retrieve\": \"first | last | all\",\n		\"fields\": [\n			{\n				\"field_name\": \"name | #url_param2\",\n				\"field_holder\": \"@field_1\",\n				\"not_found_text\": \"my field was not found\"				\n			}\n		]\n	}\n]\n```\nIf the page supports parameters, then the parameter can be accessed with `#` and the name of the paramer. Example `#url_param_name`. \n\nIn order to inlcude the retrieved data in the markdown field, include the `field_holder` that wa defined in the markdown text.\n\nWe can access multiple tables by adding another element to the array. The retrieve data from the column can be: `first` entry, `last` entry or `all` entries (concatenated with ;)', 0),
(0000000007, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000007, 0000000026, NULL, 'Only use <a href=\"https://en.wikipedia.org/wiki/Markdown\" target=\"_blank\">markdown</a> elements that can be displayed inline (e.g. bold, italic, etc).', 0),
(0000000008, 0000000008, NULL, 'The text to appear on the button.', 0),
(0000000008, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000008, 0000000027, NULL, 'Use a full URL or any special characters as defined <a href=\"https://selfhelp.psy.unibe.ch/demo/style/440\" target=\"_blank\">here</a>.', 0),
(0000000008, 0000000028, 'primary', 'The <a href=\"https://getbootstrap.com/docs/4.1/components/buttons/#examples\" target=\"_blank\">bootstrap type</a> of the button.', 0),
(0000000009, 0000000002, NULL, 'The label above the password input fields.', 0),
(0000000009, 0000000003, NULL, 'The text on the back to login link on the success page.', 0),
(0000000009, 0000000005, NULL, 'This text is displayed in an danger-alert-box if the validation fails.', 0),
(0000000009, 0000000006, NULL, 'This field is intended for custom input fields that allow the collect further information about a user (also see field `name`)', 0),
(0000000009, 0000000009, NULL, 'The placeholder for the password confirmation input field.', 0),
(0000000009, 0000000022, NULL, 'The title of the validation page.', 0),
(0000000009, 0000000034, NULL, 'The text in the card header of the validation form.', 0),
(0000000009, 0000000035, NULL, 'On successful validation a new page appears where the content of this field is displayed in a `jumbotron`.', 0),
(0000000009, 0000000036, NULL, 'The label above the username input field.', 0),
(0000000009, 0000000037, NULL, 'The placeholder for the username input field.', 0),
(0000000009, 0000000038, NULL, 'The small description text below the username input field.', 0),
(0000000009, 0000000039, NULL, 'The label above the gender selection radio buttons.', 0),
(0000000009, 0000000040, NULL, 'The label next to the male radio button option.', 0),
(0000000009, 0000000041, NULL, 'The label next to the female radio button option.', 0),
(0000000009, 0000000042, NULL, 'The text on the submit button to activate the user account.', 0),
...
(0000000010, 0000000032, NULL, 'This is the second part of the message card header if the role of the user is `Therapist`.', 0),
(0000000010, 0000000033, NULL, 'This is the second part of the message card header if the role of the user is `Subject`.', 0),
(0000000010, 0000000090, NULL, 'The text on the submit button.', 0),
(0000000010, 0000000095, 'Lobby', 'The name of the root chat room (the room every user is part of).', 0),
(0000000010, 0000000096, 'New Messages', 'This text is used as a divider between messages that are already read and new messages.', 0),
(0000000010, 0000000110, NULL, 'The notification email to be sent to receiver of the chat message. Use markdown syntax in conjunction with the field `is_html` if you want to send an email with html content. In addition to markdown, the following keyword is supported:\n- `@link` will be replaced by the link to the chat page.', 0),
(0000000010, 0000000111, NULL, 'The subject of the notification email to be sent to the receiver of the chat message. Use the following keywords to create dynamic content:\n- `@project` will be replaced by the project name.', 0),
(0000000010, 0000000114, '0', 'If *checked*, the email will be parsed as markdown and sent as html. The unparsed email content will be sent as plaintext alternative. If left *unchecked* the emails will only be sent as plaintext', 0),
(0000000011, 0000000006, NULL, 'The child elements to be added to the alert wrapper.', 0),
(0000000011, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000011, 0000000028, 'primary', 'The bootstrap color styling of the alert wrapper.', 0),
(0000000011, 0000000045, '0', 'If *checked* the alert wrapper can be dismissed by clicking on a close symbol.\r\nIf *unchecked* the close symbol is not rendered.', 0),
(0000000012, 0000000006, NULL, 'The child elements to be added to the card body.', 0),
(0000000012, 0000000022, NULL, 'The content of the card header. If not set, the card will be rendered without a header section.', 0),
(0000000012, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000012, 0000000028, 'light', 'A bootstrap-esque color styling of the card border and header.', 0),
(0000000012, 0000000046, '1', 'If the field `is_collapsible` is *checked* and the field `is_expanded` is *unchecked* the card is collapsed by default and only by clicking on the header will the body be shown. This field has no effect if `is_collapsible` is left *unchecked*.', 0),
(0000000012, 0000000047, '0', 'If *checked* the card body can be collapsed into the header by clicking on the header.\nIf left *unchecked* no such interaction is possible.', 0),
(0000000012, 0000000048, NULL, 'The target url of the edit button. If set, an edit button will appear on right of the card header and link to the specified url. If not set no button will be shown.', 0),
(0000000013, 0000000006, NULL, 'The child sections to be added to the `figure` body. Add only sections of style `image` or `audio` here.', 0),
(0000000013, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000013, 0000000049, NULL, 'The title to be prepended to the text defined in filed `caption`.', 0),
(0000000013, 0000000050, NULL, 'The caption of the figure.', 0),
(0000000014, 0000000006, NULL, 'The child sections to be added to the `form` body. This can hold any style.', 0),
(0000000014, 0000000008, NULL, 'The label on the submit button.', 0),
(0000000014, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000014, 0000000027, NULL, 'The submit URL.', 0),
(0000000014, 0000000028, NULL, 'The visual appearance of the submit button as predefined by [Bootstrap](!https://getbootstrap.com/docs/4.0/utilities/colors/).', 0),
(0000000014, 0000000051, NULL, 'If set, a cancel button will be rendered. The here defined text will be used as label for this button.', 0),
(0000000014, 0000000052, NULL, 'The target URL of the cancel button.', 0),
(0000000014, 0000000149, '0', 'Selecting submit and send email will add additional button to the form. If the user click on that button the data inut will ne send on his/her email.', 0),
(0000000014, 0000000150, '', 'The label on the submit and send button', 0),
(0000000015, 0000000022, NULL, 'The text to be shown when hovering over the image.', 0),
(0000000015, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000015, 0000000029, '1', 'If enabled the image scales responsively.', 0),
(0000000015, 0000000030, NULL, 'The alternative text to be shown if the image cannot be loaded.', 0),
(0000000015, 0000000053, NULL, 'The image source. If the image is an asset simply use the full name of the asset here.', 0),
(0000000016, 0000000008, NULL, 'If this field is set, a this text will be rendered above the input field.', 0),
(0000000016, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000016, 0000000054, 'text', 'A selection of HTML input types. Note that support for these types depends on the browser. Uf a type is not supported by a browser, usually the type `text` is used.', 0),
(0000000016, 0000000055, NULL, 'If this field is set, the text will be rendered as background inside the input field and will disappear when a value is enterd.', 0),
...
(0000000018, 0000000008, NULL, 'Specifies the clickable text. If left empty the URL as specified in the field `url` will be used.', 0),
(0000000018, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000018, 0000000027, NULL, 'Use a full URL or any special characters as defined <a href=\"https://selfhelp.psy.unibe.ch/demo/style/440\" target=\"_blank\">here</a>.', 0),
(0000000018, 0000000086, NULL, 'If checked the link will be opened in a new tab. If unchecked the link will open in the current tab.', 0),
(0000000019, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000019, 0000000028, 'primary', 'The visual appearance of the progrres bar as predefined by [Bootstrap](!https://getbootstrap.com/docs/4.0/utilities/colors/).', 0),
(0000000019, 0000000060, '0', 'The current value of the progress bar.', 0),
(0000000019, 0000000061, '1', 'The maximal value of the prpgress bar. The minimal value is 0.', 0),
(0000000019, 0000000101, '1', 'If enabled diagonal stripes are visualized on the progress bar.', 0),
(0000000019, 0000000102, '1', 'If enabled a label of the form `<count>/<count_max>` is displayed on the proggress bar where `<count>` is the value defined in field `count` and `<count_max>` the value defined in field `count_max`.', 0),
(0000000020, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000020, 0000000028, 'light', 'The visual appearance of the buttons as predefined by [Bootstrap](!https://getbootstrap.com/docs/4.0/utilities/colors/).', 0),
(0000000020, 0000000050, NULL, 'A question with a binary answer (e.g. Right, Wrong).', 0),
(0000000020, 0000000062, NULL, 'The label on the first answer button (e.g. right). Clicking this button will reveal the content as defined in the field `right_content`.', 0),
(0000000020, 0000000063, NULL, 'The label on the second answer button (e.g. wrong). Clicking this button will reveal the content as defined in the field `wrong_content`.', 0),
(0000000020, 0000000064, NULL, 'The body to the first answer button as defined in field `label_right`. The content of this field usually states whether this answer was correct or false and provides an explanation as to why.', 0),
(0000000020, 0000000065, NULL, 'The body to the second answer button as defined in field `label_wrong`. The content of this field usually states whether this answer was correct or false and provides an explanation as to why.', 0),
(0000000021, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000021, 0000000024, NULL, 'The text to be rendered with mono-space font.', 0),
(0000000022, 0000000008, NULL, 'If this field is set, a this text will be rendered above the selection.', 0),
(0000000022, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000022, 0000000030, NULL, 'This field specifies the text that is displayed on the disabled option when no default value is defined', 0),
(0000000022, 0000000056, '0', 'If enabled the form can only be submitted if a value is selected.', 0),
(0000000022, 0000000057, NULL, 'The name of the selection form field. This name must be unique within a form.', 0),
(0000000022, 0000000058, NULL, 'The preselected item of the selection elements.', 0),
...
(0000000022, 0000000067, '0', 'If enabled the selction items will be rendered as a list where multiple items can be selected as opposed to a dropdown menu.', 0),
...
(0000000023, 0000000058, NULL, 'The preselected position of the slider.', 0),
(0000000023, 0000000068, NULL, 'This field expects a [JSON](!https://www.json.org/json-en.html) list of labels. Each label will be assigned to a slider position so make sure that the number of labels matches the range defined with the fields `min` and `max`.', 0),
(0000000023, 0000000069, '0', 'The minimal value of the range.', 0),
(0000000023, 0000000070, '5', 'The maximal value of the range', 0),
(0000000024, 0000000006, NULL, 'The child sections to be added to the `tab` body. This can hold any style.', 0),
(0000000024, 0000000008, NULL, NULL, 0),
...
(0000000026, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000026, 0000000055, NULL, 'If this field is set, the text will be rendered as background inside the textarea and will disappear when a value is enterd.', 0),
(0000000026, 0000000056, '0', 'If enabled the form can only be submitted if a value is enterd in this textarea.', 0),
(0000000026, 0000000057, NULL, 'The name of the textarea form field. This name must be unique within a form.', 0),
(0000000026, 0000000058, NULL, 'The default value of the textarea form field.', 0),
(0000000027, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000027, 0000000029, '1', NULL, 0),
(0000000027, 0000000030, NULL, 'The alternative text to be displayed if the video cannot be loaded.', 0),
...
(0000000028, 0000000031, NULL, 'This text will be added as a perfix to each root item.', 0),
...
(0000000028, 0000000072, NULL, 'This field only has an effect if root items have an URL defined (see field `items`). If not defined, links on root items will be displayed as symbols. To expand the root item one would click on the root item and to follow to the link one would click on the link symbol. If this field is set instead of the link symbol, a new chlid element will be generated which serves as a link to the URL of the root item. The here defined text will be used as label for this link.', 0),
(0000000028, 0000000083, NULL, 'Define any unique name here if multiple accordionList styles are used on the same page.', 0),
(0000000028, 0000000084, '0', 'Defines which id is marked as active. This will also cause the corresponding root item to be expanded.', 0),
(0000000030, 0000000006, NULL, 'Add sections here wich will be rendered below the content defined in field `text_md`.', 0),
(0000000030, 0000000022, NULL, 'All navigation sections of a navigation page can be rendered as a list style. This field specifies the name of this navigation section to be used in such a list style.', 0),
(0000000030, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000030, 0000000025, '# @title', 'The content (markdown) of this field will be rendered at the top of the navigation section. Further sections added through the field `children` will be rendered below this. Note that here, the keyword `@title` can be used and will be replaced by the content of the field `title`.', 0),
(0000000031, 0000000029, '1', NULL, 0),
(0000000031, 0000000031, NULL, NULL, 0),
(0000000031, 0000000072, NULL, NULL, 0),
(0000000031, 0000000073, NULL, NULL, 0),
(0000000031, 0000000074, NULL, NULL, 0),
(0000000031, 0000000075, NULL, NULL, 0),
(0000000031, 0000000104, '1', NULL, 0),
(0000000032, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000032, 0000000031, NULL, 'If this is set the list will be collapse on small screens and the here defined text will be displayed as title of the collpsed list.', 0),
(0000000032, 0000000046, '0', 'If enabled all items in the list will be expanded by default. If disabled all items will be collapsed by default. This field only has an effect if `is_collapsible` is enabled.', 0),
(0000000032, 0000000047, '1', 'If enabled all items with child items are collapsible.', 0),
...
(0000000032, 0000000077, NULL, 'If defined a small text input field is rendered on top of the list. This input field allows to search for any item within the list.', 0),
(0000000032, 0000000083, NULL, 'Defines which id is marked as active. This will also cause the corresponding root item to be expanded.', 0),
(0000000032, 0000000084, '0', NULL, 0),
(0000000033, 0000000023, NULL, 'Use this field to add custom CSS classes to the root navigation page container.', 0),
(0000000033, 0000000029, '1', NULL, 0),
(0000000033, 0000000031, NULL, NULL, 0),
(0000000033, 0000000046, '1', NULL, 0),
(0000000033, 0000000047, '0', NULL, 0),
(0000000033, 0000000073, NULL, NULL, 0),
(0000000033, 0000000074, NULL, NULL, 0),
(0000000033, 0000000075, '1', NULL, 0),
(0000000033, 0000000077, NULL, NULL, 0),
(0000000033, 0000000089, NULL, 'Use this field to add custom CSS classes to the navigation menu of a navigation page.', 0),
(0000000033, 0000000104, '1', NULL, 0),
(0000000034, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
...
(0000000034, 0000000078, '0', 'If enabled the list is sortable. Note that this feature requires additional javascript code. This only has an effect if the field `is_editable` is enabled.', 0),
(0000000034, 0000000079, '0', 'If enabled the list can be changed (see the fields `is_sortable`, `url_delete`, `url_add`).', 0),
(0000000034, 0000000080, NULL, 'If set next to each item in the list a cross symbol will be rendered. Each symbol is a link with an URL as defined here. The string `:did` will be replaced with the id of the clicked item. For this field to have an effect, the field `is_editable` must be enabled.', 0),
(0000000034, 0000000081, NULL, 'This text will be used on the button to add new elements to the list. This field only has an effect if the field `is_editable` is enabled and the field `url_add` is defined.', 0),
(0000000034, 0000000082, NULL, 'If set, at the top of the list a button with the text as defined with the field `label_add` is rendered. This field defines the link URL of the button. For this field to have an effect, the field `is_editable` must be enabled.', 0),
(0000000035, 0000000004, NULL, 'The label on the submit button.', 0),
(0000000035, 0000000025, NULL, 'The description to be displayed on the page when a user wants to reset the password.', 0),
(0000000035, 0000000028, NULL, 'The bootstrap color of the submit button.', 0),
(0000000035, 0000000035, NULL, 'The success message to be shown when an email address was successfully stored in the database (if enabled) and the automatic emails were sent successfully.', 0),
(0000000035, 0000000055, NULL, 'The placeholder in the email input field.', 0),
(0000000035, 0000000110, NULL, 'The email to be sent to the the email address that was entered into the form. Use markdown syntax in conjunction with the field `is_html` if you want to send an email with html content. In addition to markdown, the following keyword is supported:\n- `@link` will be replaced by the activation link the user needs to reset the password.', 0),
...
(0000000035, 0000000114, '0', 'If *checked*, the email will be parsed as markdown and sent as html. The unparsed email content will be sent as plaintext alternative. If left *unchecked* the emails will only be sent as plaintext', 0),
(0000000036, 0000000006, NULL, 'The child sections to be added to the `formUserInput` body. This can hold any style.', 0),
(0000000036, 0000000008, NULL, 'The label on the submit button.', 0),
(0000000036, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000036, 0000000028, 'primary', 'The visual appearance of the submit button as predefined by [Bootstrap](!https://getbootstrap.com/docs/4.0/utilities/colors/).', 0),
(0000000036, 0000000035, NULL, 'The here defined text will be rendered upon successful submission of data. If the submission fails, an error message will indicate the reason.', 0),
(0000000036, 0000000057, NULL, 'A unique name to identify the form when exporting the collected data.', 0),
(0000000036, 0000000087, '0', 'This fiels allows to control how the data is saved in the database:\n - `disabled`: The submission of data will always overwrite prior submissions of the same user. This means that the user will be able to continously update the data that was submitted here. Any input field that is used within this form will always show the current value stored in the database (if nothing has been submitted as of yet, the input field will be empty or set to a default).\n - `enabled`: Each submission will create a new entry in the database. Once entered, an entry cannot be removed or modified. Any input field within this form will always be empty or set to a default value (nothing will be read from the database).', 0),
...
(0000000036, 0000000145, '', 'In this ***JSON*** field we can configure a data retrieve params from the DB, either `static` or `dynamic` data. Example: \n ```\n [\n	{\n		\"type\": \"static|dynamic\",\n		\"table\": \"table_name | #url_param1\",\n        \"retrieve\": \"first | last | all\",\n		\"fields\": [\n			{\n				\"field_name\": \"name | #url_param2\",\n				\"field_holder\": \"@field_1\",\n				\"not_found_text\": \"my field was not found\"				\n			}\n		]\n	}\n]\n```\nIf the page supports parameters, then the parameter can be accessed with `#` and the name of the paramer. Example `#url_param_name`. \n\nIn order to inlcude the retrieved data in the markdown field, include the `field_holder` that wa defined in the markdown text.\n\nWe can access multiple tables by adding another element to the array. The retrieve data from the column can be: `first` entry, `last` entry or `all` entries (concatenated with ;)\n\n[More information](https://selfhelp.psy.unibe.ch/demo/style/454)', 0),
(0000000036, 0000000149, '0', 'Selecting submit and send email will add additional button to the form. If the user click on that button the data inut will ne send on his/her email.', 0),
...
(0000000038, 0000000057, NULL, 'The name of the radio form field. This name must be unique within a form.', 0),
(0000000038, 0000000058, NULL, 'The preselected item of the radio elements.', 0),
...
(0000000038, 0000000085, NULL, 'If enabled the radio items will be rendered in one line as opposed to one below the other.', 0),
(0000000039, 0000000012, NULL, 'The title of the modal form that pops up when the delete button is clicked.\n\nNote the following important point:\n- this field only has an effect if `is_log` is enabled.', 0),
(0000000039, 0000000013, NULL, 'The label of the remove button of the modal form.\n\nNote the following important points:\n- this field only has an effect if `is_log` is enabled.\n- if this field is not set, the remove button is not rendered.\n- entries that are removed with this button are only marked as removed but not deleted from the DB.', 0),
(0000000039, 0000000014, NULL, 'The content of the modal form that pops up when the delete button is clicked.\n\nNote the following important point:\n- this field only has an effect if `is_log` is enabled.', 0),
(0000000039, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000039, 0000000053, NULL, 'The name of the source form (i.e. the field `name` of the target form style).', 0),
(0000000039, 0000000087, '0', 'If *checked*, the style will render a table where each row represents all fields of the source form at the time instant of data submission.\n\nIf left *unchecked*, a table is rendered where each row represents one field of the source form.\n\nNote the following important points:\n- Check this only if the source form also has `is_log` checked.\n- The fields, `delete_title`, `label_date_time`, `label_delete`, and `delete_content` only have an effect if `is_log` is *checked*.', 0),
(0000000039, 0000000088, NULL, 'The column title of the timestamp column.\n\nNote the following important point:\n- this field only has an effect if `is_log` is enabled.', 0),
(0000000039, 0000000139, NULL, 'Search for the name of the anchor section to jump to after submitting the delete form. The ID of the section will be used as anchor. If this field is not set the page will jump to the top after submission.', 0),
(0000000040, 0000000006, NULL, 'The child sections to be added to the `div` body. This can hold any style.', 0),
(0000000040, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000041, 0000000001, NULL, 'The placeholder in the email input field.', 0),
(0000000041, 0000000002, NULL, 'The placeholder in the validation code input field.', 0),
(0000000041, 0000000005, NULL, 'This text is displayed in a danger-alert-box whenever the registration fails.', 0),
(0000000041, 0000000022, NULL, 'The text displayed in the register card header.', 0),
(0000000041, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000041, 0000000028, 'success', 'This allows to choose the colour scheme for the register form.', 0),
(0000000041, 0000000035, NULL, 'Upon successful registration the registration form is replaced with a `jumbotron` which hold this text.', 0),
(0000000041, 0000000044, NULL, 'Upon successful registration the registration form is replaced with a `jumbotron` which holds this text as a heading.', 0),
(0000000041, 0000000090, NULL, 'The text on the registration button.', 0),
(0000000041, 0000000140, '0', 'If checked any user can register without a registration code. The code will be automatically generated upon registration', 0),
(0000000041, 0000000143, '3', 'Select the default group in which evey new user is assigned.', 0),
(0000000042, 0000000006, NULL, 'The children to be rendered if the condition defined by the field `condition` resolves to true.', 0),
...
(0000000044, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
...
(0000000044, 0000000083, NULL, 'Define any unique name here if multiple carousel styles are used on the same page.', 0),
(0000000044, 0000000099, '1', 'If enabled the carusel is rendered with control arrows on either side of the image.', 0),
(0000000044, 0000000100, '0', 'If enabled the carousel is rendered with carousel position indicaters at the bottom of the image.', 0),
(0000000044, 0000000103, '0', 'If enabled images will fade from one to another instead of using the default sliding animation.', 0),
(0000000045, 0000000105, NULL, 'The JSON string to specify the (potentially) nested base styles.\r\n\r\nThere are a few things to note:\r\n - the key `_baseStyle` must be used to indicate that the assigned object is a *style object*\r\n - the *style object* must contain the key `_name` where the value must match a style name\r\n - the *style object* must contain the key `_fields` where the value is an object holding all required fields of the style (refer to the <a href=\"https://selfhelp.psy.unibe.ch/demo/styles\" target=\"_blank\">style documentation</a> for more information)', 0),
(0000000046, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000046, 0000000028, NULL, '.Use the type to change the appearance of individual progress bars', 0),
(0000000046, 0000000101, NULL, 'iIf set apply a stripe via CSS gradient over the progress bar’s background color.', 0),
(0000000046, 0000000102, NULL, 'If set display the progress in numbers ontop of the progress bar.', 0),
(0000000047, 0000000006, NULL, 'The child sections to be added to the `fromMermaid` body. Add only sections of style `input` here. If the field `name` of a child section matches the name of a node in the mermaid diagram, this node becomes editable. To edit, simply click on the node and a modal form is opened.', 0),
(0000000047, 0000000008, NULL, 'The label on the submit button in the edit window. This field only has an effect if a mermaid node is editable.', 0),
(0000000047, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000047, 0000000028, NULL, 'The visual appearance of the submit button in the edit window as predefined by [Bootstrap](!https://getbootstrap.com/docs/4.0/utilities/colors/).', 0),
(0000000047, 0000000035, NULL, 'The here defined text will be rendered upon successful submission of data. If the submission fails, an error message will indicate the reason.', 0),
(0000000047, 0000000057, NULL, 'A unique name to identify the form when exporting the collected data.', 0),
(0000000047, 0000000107, NULL, 'Use <a href=\"https://mermaidjs.github.io/demos.html\" target=\"_blank\">mermaid markdown</a> syntax here.', 0),
(0000000048, 0000000008, NULL, 'The label on the submit button.', 0),
(0000000048, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000048, 0000000028, NULL, 'The bootstrap color of the submit button.', 0),
(0000000048, 0000000035, NULL, 'The success message to be shown when an email address was successfully stored in the database (if enabled) and the automatic emails were sent successfully.', 0),
(0000000048, 0000000055, NULL, 'The placeholder in the email input field.', 0),
(0000000048, 0000000108, NULL, 'A list of email addresses to be notified on submit with an email as defined in field `email_admins`. Use `json` syntax to specify the list of admins (e.g. `[\"__admin_1__\", ..., \"__admin_n__\"]`) where `__admin_*__` is the email address of an admin.', 0),
(0000000048, 0000000109, NULL, 'The email to be sent to the the list of admins defined in the field `admins`. Use markdown syntax in conjunction with the field `is_html` if you want to send an email with html content. In addition to markdown, the following keyword is supported:\n- `@email` will be replaced by the email address entered in the form.', 0),
...
(0000000048, 0000000112, NULL, 'The list of attachments to the email to be sent to the the address that was entered into the form. Use `json` syntax to specify a list of assets (e.g. `[\"__asset_1__\", ..., \"__asset_n__\"]`) where `__asset_*__` is the name of an uploaded asset.', 0),
(0000000048, 0000000113, '0', 'If checked, the entered email address will be stored in the database.', 0),
(0000000048, 0000000114, '0', 'If *checked*, the email will be parsed as markdown and sent as html. The unparsed email content will be sent as plaintext alternative. If left *unchecked* the emails will only be sent as plaintext', 0),
(0000000049, 0000000008, NULL, 'The label to be displayed above the autocomplete input field.', 0),
(0000000049, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000049, 0000000055, NULL, 'The placeholder text to be displayed in the autocomplete input field.', 0),
(0000000049, 0000000056, NULL, 'True if the field is required, false otherwise.', 0),
(0000000049, 0000000057, NULL, 'The name of the autocomplete input field.', 0),
(0000000049, 0000000058, NULL, 'The default value to be set in the hidden autocomplete value input field.', 0),
(0000000049, 0000000097, NULL, 'If set to true, debug information is shown in an alert box.', 0),
(0000000049, 0000000118, NULL, 'The name of the hidden autocomplete value input field.', 0),
(0000000049, 0000000119, NULL, 'The name of the class to be instantiated in the AJAX request.', 0),
(0000000049, 0000000120, NULL, 'The name of the method to be called on the class instance as defined in `callback_class`.', 0),
(0000000050, 0000000022, NULL, 'The title to be rendered on top of teh graph. This field is here purely for convenience as the title of a graph can also be defined in the field `layout`', 0),
(0000000050, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000050, 0000000122, NULL, 'Define the data traces to be rendered. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
(0000000050, 0000000123, NULL, 'Define the layout of the graph. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
(0000000050, 0000000124, NULL, 'Define the configuration of the graph. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
...
(0000000051, 0000000129, '0', 'If checked, the labels defined in `value_types` are displayed next to a node with the corresponding type', 0),
(0000000051, 0000000130, '1', 'If checked, the label defined in `form_field_names` is displayed on top of a grouped node column. This field only has an effect if `is_grouped` is enabled.', 0),
(0000000051, 0000000131, '1', 'If checked, the nodes are positioned as follows:\n - each node with the same form field name is aligned vertically (same x coordinate)\n - within one column nodes are sorted by value types (by their indices as defined in `value_types`', 0),
(0000000051, 0000000132, '1', 'This option only takes effect when using **dynamic** data. If checked, only data from the current logged-in user is used. If unchecked, data form all users is used.', 0),
(0000000052, 0000000008, NULL, 'The name to be rendered on the filter button.', 0),
(0000000052, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000052, 0000000028, NULL, 'The visual apperance of the button as predefined by bootstrap.', 0),
(0000000052, 0000000057, NULL, 'The name of the table column or form field to filter on.', 0),
(0000000052, 0000000058, NULL, 'The value of the filter. All data sets of the data source (as specified by `data-source`) where the field (as specified by `name`) holds a value equal to the one indicated here will be selected.', 0),
(0000000052, 0000000121, NULL, 'The source of the data to be filtered.', 0),
(0000000053, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000053, 0000000028, NULL, 'The visual apperance of the buttons as predefined by bootstrap.', 0),
(0000000053, 0000000029, '0', 'If checked, the button group is streched to fill 100% of the available width. If unchecked, the button group is stretched to fit all text within each button but never more than available space.', 0),
(0000000053, 0000000057, NULL, 'The name of the table column or form field to filter on.', 0),
(0000000053, 0000000068, NULL, 'The names to be rendered on the filter buttons. Use a JSON array to specify all labels. The labels must correspond to the values as specified in `values`', 0),
(0000000053, 0000000121, NULL, 'The source of the data to be filtered.', 0),
(0000000053, 0000000134, NULL, 'The value of each filter button. All data sets of the data source (as specified by `data-source`) where the field (as specified by `name`) holds a value equal to the one indicated here will be selected. Use a JSON array to specify all values. The values must correspond to the labels as specified in `labels`.', 0),
(0000000053, 0000000135, '0', 'If checked, the button group is rendered as a vertical stack. If unchecked, the button group is rendered as a vertical list.', 0),
(0000000054, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000054, 0000000057, NULL, 'The name of the table column or form field to use to render a pie diagram.', 0),
(0000000054, 0000000121, NULL, 'The source of the data to be used to render a pie diagram.', 0),
(0000000054, 0000000123, NULL, 'Define the layout of the graph. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
(0000000054, 0000000124, NULL, 'Define the configuration of the graph. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
...
(0000000054, 0000000132, '1', 'This option only takes effect when using **dynamic** data. If checked, only data from the current logged-in user is used. If unchecked, data form all users is used.', 0),
(0000000054, 0000000136, '0', 'Use this to render a donut chart. Use a percentage from 0 to 100 where 0% means no hole and 100% a hole as big as the chart.', 0),
(0000000054, 0000000137, NULL, 'Allows to define the information to be rendered in the hover box. Use \"none\" to disable the hover box. Refer to the [Plotly.js documentation](!https://plotly.com/javascript/reference/#pie-hoverinfo) for more information.', 0),
(0000000054, 0000000138, NULL, 'Allows to define the information to be rendered on each pie slice. Use \"none\" to show no text. Refer to the [Plotly.js documentation](!https://plotly.com/javascript/reference/#pie-textinfo) for more information.', 0),
(0000000055, 0000000023, NULL, 'Allows to assign CSS classes to the root item of the style.', 0),
(0000000055, 0000000057, NULL, 'The name of the table column or form field to use to render a pie diagram.', 0),
(0000000055, 0000000121, NULL, 'The source of the data to be used to render a pie diagram.', 0),
(0000000055, 0000000123, NULL, 'Define the layout of the graph. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
(0000000055, 0000000124, NULL, 'Define the configuration of the graph. Refer to the documentation of [Plotly.js](https://plotly.com/javascript/) for more information', 0),
...
(0000000055, 0000000132, '1', 'This option only takes effect when using **dynamic** data. If checked, only data from the current logged-in user is used. If unchecked, data form all users is used.', 0),
