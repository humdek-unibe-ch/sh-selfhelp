...
INSERT INTO `styles_fields` (`id_styles`, `id_fields`, `help`) VALUES (@id_style_chat, @id_field_email_user, 'The notification email to be sent to receiver oif the chat message. Use markdown syntax in conjunction with the field `is_html` if you want to send an email with html content. In addition to markdown, the following keyword is supported:\n- `@link` will be replaced by the link to the chat page.');
