...
-- add column user_name to table users
CALL add_table_column('users', 'user_name', "VARCHAR(100) UNIQUE");

-- set all old users with emails to have user_name as their email
UPDATE users
SET user_name = email;
