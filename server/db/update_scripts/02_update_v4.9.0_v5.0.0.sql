...
INSERT IGNORE INTO `styles_fields` (`id_styles`, `id_fields`, `default_value`, `help`, `hidden`) VALUES (get_style_id('messageBoard'), get_field_id('name'), '', 'The name of the form where the replies will be stored. The name is autogenerated', 1);
INSERT IGNORE INTO `styles_fields` (`id_styles`, `id_fields`, `default_value`, `help`, `hidden`) VALUES (get_style_id('messageBoard'), get_field_id('is_log'), 1, 'This field allows to control how the data is saved in the database:
