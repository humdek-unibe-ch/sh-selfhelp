...
VALUES (NULL, 'sh_global_css', '/admin/global_css', 'GET|POST', (SELECT id FROM actions WHERE `name` = 'backend' LIMIT 0,1), NULL, @id_page_globals, '5', 0, NULL, (SELECT id FROM pageType WHERE `name` = 'sh_global_css' LIMIT 0,1), (SELECT id FROM lookups WHERE lookup_code = 'web'));
