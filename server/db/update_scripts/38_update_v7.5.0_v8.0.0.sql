...
INSERT IGNORE INTO `lookups` (`type_code`,`lookup_code`,`lookup_value`,`lookup_description`) VALUES ('actions','cms-api','cms-api',NULL);
SET @page_keyword = 'cms-api_v1_content_get_all_routes'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[content:class]/[all_routes:method]', 'GET', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 1); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Get Navigation Pages'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Get Navigation Pages');
...
SET @page_keyword = 'cms-api_v1_content_get_page'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[content:class]/[page:method]/[slug:keyword]', 'GET', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 1); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Get Page'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Get Page');
SET @page_keyword = 'cms-api_v1_content_put_page'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[content:class]/[page:method]/[slug:keyword]', 'PUT', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 1); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Put Data to Page'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Put Data to Page');
SET @page_keyword = 'cms-api_v1_auth_login'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[auth:class]/[login:method]', 'POST', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 1); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Login'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Login');
...
SET @page_keyword = 'cms-api_v1_admin_get_access'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[admin:class]/[access:method]', 'GET', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 0); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Admin - get access'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Admin - get access'); INSERT IGNORE INTO `acl_groups` (`id_groups`, `id_pages`, `acl_select`, `acl_insert`, `acl_update`, `acl_delete`) VALUES ((SELECT `id` FROM `groups` WHERE `name` = 'admin'), (SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), '1','0','0','0');
SET @page_keyword = 'cms-api_v1_admin_get_pages'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[admin:class]/[pages:method]', 'GET', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 0); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Admin - get pages'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Admin - get pages'); INSERT IGNORE INTO `acl_groups` (`id_groups`, `id_pages`, `acl_select`, `acl_insert`, `acl_update`, `acl_delete`) VALUES ((SELECT `id` FROM `groups` WHERE `name` = 'admin'), (SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), '1','0','0','0');
SET @page_keyword = 'cms-api_v1_admin_page_fields'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[admin:class]/[page_fields:method]/[slug:page_keyword]', 'GET', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 0); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Get Page Fields'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Get Page Fields'); INSERT IGNORE INTO `acl_groups` (`id_groups`, `id_pages`, `acl_select`, `acl_insert`, `acl_update`, `acl_delete`) VALUES ((SELECT `id` FROM `groups` WHERE `name` = 'admin'), (SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), '1','0','0','0');
SET @page_keyword = 'cms-api_v1_admin_page_sections'; INSERT IGNORE INTO `pages` (`keyword`, `url`, `protocol`, `id_actions`, `id_navigation_section`, `parent`, `is_headless`, `nav_position`, `footer_position`, `id_type`, `id_pageAccessTypes`, `is_open_access`) VALUES (@page_keyword, '/cms-api/v1/[admin:class]/[page_sections:method]/[slug:page_keyword]', 'GET', (SELECT `id` FROM `lookups` WHERE `type_code` = 'actions' AND `lookup_code` = 'cms-api' LIMIT 1), NULL, NULL, '0', NULL, NULL, (SELECT `id` FROM `pageType` WHERE `name` = 'intern' LIMIT 1), (SELECT `id` FROM `lookups` WHERE `lookup_code` = 'mobile_and_web' LIMIT 1), 0); INSERT IGNORE INTO `pages_fields_translation` (`id_pages`, `id_fields`, `id_languages`, `content`) VALUES ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000001', 'Get Page Sections'), ((SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), get_field_id('title'), '0000000002', 'Get Page Sections'); INSERT IGNORE INTO `acl_groups` (`id_groups`, `id_pages`, `acl_select`, `acl_insert`, `acl_update`, `acl_delete`) VALUES ((SELECT `id` FROM `groups` WHERE `name` = 'admin'), (SELECT `id` FROM `pages` WHERE `keyword` = @page_keyword), '1','0','0','0');
