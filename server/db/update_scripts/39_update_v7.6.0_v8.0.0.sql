...
-- Auth routes
('auth_login','v1','/auth/login','App\\Controller\\Api\\V1\\Auth\\AuthController::login','POST',NULL,JSON_OBJECT('username',JSON_OBJECT('in','body','required',true,'type','string'),'password',JSON_OBJECT('in','body','required',true,'type','string'))),
('auth_two_factor_verify','v1','/auth/two-factor-verify','App\\Controller\\Api\\V1\\Auth\\AuthController::twoFactorVerify','POST',NULL,JSON_OBJECT('code',JSON_OBJECT('in','body','required',true,'type','string'),'id_users',JSON_OBJECT('in','body','required',true,'type','integer'))),
('auth_refresh_token','v1','/auth/refresh-token','App\\Controller\\Api\\V1\\Auth\\AuthController::refreshToken','POST',NULL,JSON_OBJECT('refresh_token',JSON_OBJECT('in','body','required',true,'type','string'))),
('auth_logout','v1','/auth/logout','App\\Controller\\Api\\V1\\Auth\\AuthController::logout','POST',NULL,JSON_OBJECT('access_token',JSON_OBJECT('in','body','required',false,'type','string'),'refresh_token',JSON_OBJECT('in','body','required',false,'type','string'))),
...
('admin_pages_get_one','v1','/admin/pages/{page_keyword}','App\\Controller\\Api\\V1\\Admin\\AdminPageController::getPage','GET',JSON_OBJECT('page_keyword','[A-Za-z0-9_-]+'),JSON_OBJECT('page_keyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'))),
('admin_pages_create','v1','/admin/pages','App\\Controller\\Api\\V1\\Admin\\AdminPageController::createPage','POST',NULL,JSON_OBJECT('keyword',JSON_OBJECT('in','body','required',true,'type','string'),'page_access_type_id',JSON_OBJECT('in','body','required',true,'type','integer'),'is_headless',JSON_OBJECT('in','body','required',false,'type','boolean'),'is_open_page',JSON_OBJECT('in','body','required',false,'type','boolean'),'url',JSON_OBJECT('in','body','required',false,'type','string'),'nav_position',JSON_OBJECT('in','body','required',false,'type','integer'),'footer_position',JSON_OBJECT('in','body','required',false,'type','integer'),'parent',JSON_OBJECT('in','body','required',false,'type','string'))),
('admin_pages_update','v1','/admin/pages/{page_keyword}','App\\Controller\\Api\\V1\\Admin\\AdminPageController::updatePage','PUT',JSON_OBJECT('page_keyword','[A-Za-z0-9_-]+'),JSON_OBJECT('page_keyword',JSON_OBJECT('in','path','required',true,'type','string'),'pageData',JSON_OBJECT('in','body','required',true,'type','object'),'fields',JSON_OBJECT('in','body','required',true,'type','array'))),
('admin_pages_delete','v1','/admin/pages/{page_keyword}','App\\Controller\\Api\\V1\\Admin\\AdminPageController::deletePage','DELETE',JSON_OBJECT('page_keyword','[A-Za-z0-9_-]+'),JSON_OBJECT('page_keyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'))),
('admin_pages_sections_get','v1','/admin/pages/{page_keyword}/sections','App\\Controller\\Api\\V1\\Admin\\AdminPageController::getPageSections','GET',JSON_OBJECT('page_keyword','[A-Za-z0-9_-]+'),JSON_OBJECT('page_keyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'))),

-- Admin Languages (using existing correct pattern)
...
('admin_languages_get_one', 'v1', '/admin/languages/{id}', 'App\\Controller\\Api\\V1\\Admin\\AdminLanguageController::getLanguage', 'GET', JSON_OBJECT('id', '[0-9+]'), JSON_OBJECT('id', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'))),
('admin_languages_create', 'v1', '/admin/languages', 'App\\Controller\\Api\\V1\\Admin\\AdminLanguageController::createLanguage', 'POST', NULL, JSON_OBJECT('locale', JSON_OBJECT('in', 'body', 'required', true, 'type', 'string'), 'language', JSON_OBJECT('in', 'body', 'required', true, 'type', 'string'), 'csv_separator', JSON_OBJECT('in', 'body', 'required', false, 'type', 'string'))),
('admin_languages_update', 'v1', '/admin/languages/{id}', 'App\\Controller\\Api\\V1\\Admin\\AdminLanguageController::updateLanguage', 'PUT', JSON_OBJECT('id', '[0-9+]'), JSON_OBJECT('id', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'locale', JSON_OBJECT('in', 'body', 'required', false, 'type', 'string'), 'language', JSON_OBJECT('in', 'body', 'required', false, 'type', 'string'), 'csv_separator', JSON_OBJECT('in', 'body', 'required', false, 'type', 'string'))),
('admin_languages_delete', 'v1', '/admin/languages/{id}', 'App\\Controller\\Api\\V1\\Admin\\AdminLanguageController::deleteLanguage', 'DELETE', JSON_OBJECT('id', '[0-9+]'), JSON_OBJECT('id', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'))),

-- Admin Page Sections (Corrected to 7 values and params for path variables)
('admin_add_section_to_page', 'v1', '/admin/pages/{pageKeyword}/sections', 'App\\Controller\\Api\\V1\\Admin\\AdminPageController::addSectionToPage', 'POST', JSON_OBJECT('pageKeyword', '[a-zA-Z0-9_-]+'), JSON_OBJECT('pageKeyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'), 'sectionData', JSON_OBJECT('in', 'body', 'required', true, 'type', 'object'))),
('admin_update_section_in_page', 'v1', '/admin/pages/{pageKeyword}/sections/{sectionId}', 'App\\Controller\\Api\\V1\\Admin\\AdminPageController::updateSectionInPage', 'PUT', JSON_OBJECT('pageKeyword', '[a-zA-Z0-9_-]+', 'sectionId', '\\d+'), JSON_OBJECT('pageKeyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'), 'sectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'sectionData', JSON_OBJECT('in', 'body', 'required', true, 'type', 'object'))),
('admin_remove_section_from_page', 'v1', '/admin/pages/{pageKeyword}/sections/{sectionId}', 'App\\Controller\\Api\\V1\\Admin\\AdminPageController::removeSectionFromPage', 'DELETE', JSON_OBJECT('pageKeyword', '[a-zA-Z0-9_-]+', 'sectionId', '\\d+'), JSON_OBJECT('pageKeyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'), 'sectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'))),

-- Admin Section in Section (Corrected to 7 values and params for path variables)
('admin_add_section_to_section', 'v1', '/admin/sections/{parentSectionId}/sections', 'App\\Controller\\Api\\V1\\Admin\\AdminSectionController::addSectionToSection', 'POST', JSON_OBJECT('parentSectionId', '\\d+'), JSON_OBJECT('parentSectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'sectionData', JSON_OBJECT('in', 'body', 'required', true, 'type', 'object'))),
('admin_update_section_in_section', 'v1', '/admin/sections/{parentSectionId}/sections/{childSectionId}', 'App\\Controller\\Api\\V1\\Admin\\AdminSectionController::updateSectionInSection', 'PUT', JSON_OBJECT('parentSectionId', '\\d+', 'childSectionId', '\\d+'), JSON_OBJECT('parentSectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'childSectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'sectionData', JSON_OBJECT('in', 'body', 'required', true, 'type', 'object'))),
('admin_remove_section_from_section', 'v1', '/admin/sections/{parentSectionId}/sections/{childSectionId}', 'App\\Controller\\Api\\V1\\Admin\\AdminSectionController::removeSectionFromSection', 'DELETE', JSON_OBJECT('parentSectionId', '\\d+', 'childSectionId', '\\d+'), JSON_OBJECT('parentSectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'childSectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'))),
('admin_delete_section', 'v1', '/admin/sections/{sectionId}', 'App\\Controller\\Api\\V1\\Admin\\AdminSectionController::deleteSection', 'DELETE', JSON_OBJECT('sectionId', '\\d+'), JSON_OBJECT('sectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'))),

-- Admin Styles (Assuming this was a typo and meant AdminLanguageController::getAllLanguages, corrected to use AdminStyleController)
('admin_styles_get', 'v1', '/admin/styles', 'App\\Controller\\Api\\V1\\Admin\\AdminStyleController::getStyles', 'GET', NULL, NULL),

-- Admin Create Section (Corrected params for path variables, assuming body data for creation)
('admin_create_section_in_page', 'v1', '/admin/pages/{pageKeyword}/sections/create', 'App\\Controller\\Api\\V1\\Admin\\AdminSectionController::createPageSection', 'POST', JSON_OBJECT('pageKeyword', '[\\w-]+'), JSON_OBJECT('pageKeyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'), 'sectionData', JSON_OBJECT('in', 'body', 'required', true, 'type', 'object'))),
('admin_create_section_in_section', 'v1', '/admin/sections/{parentSectionId}/sections/create', 'App\\Controller\\Api\\V1\\Admin\\AdminSectionController::createChildSection', 'POST', JSON_OBJECT('parentSectionId', '\\d+'), JSON_OBJECT('parentSectionId', JSON_OBJECT('in', 'path', 'required', true, 'type', 'integer'), 'sectionData', JSON_OBJECT('in', 'body', 'required', true, 'type', 'object'))),

-- Public pages route
('pages_get_all_public','v1','/pages','App\\Controller\\Api\\V1\\Frontend\\PageController::getPages','GET',NULL,NULL), -- Renamed from pages_get_all to avoid conflict if admin has same name
('pages_get_one_public','v1','/pages/{page_keyword}','App\\Controller\\Api\\V1\\Frontend\\PageController::getPage','GET',JSON_OBJECT('page_keyword','[A-Za-z0-9_-]+'),JSON_OBJECT('page_keyword', JSON_OBJECT('in', 'path', 'required', true, 'type', 'string'))), -- Added params for page_keyword
('languages_get_all_public', 'v1', '/languages', 'App\\Controller\\Api\\V1\\Frontend\\LanguageController::getAllLanguages', 'GET', NULL, NULL); -- Renamed from languages_get_all
