...
BEGIN  
    ...
    ELSE 
		begin
		SET @sql = CONCAT('select user_id, form_name, edit_time, record_id, user_name, user_code, ', @sql, ' , removed as deleted from view_user_input
		where form_id = ', form_id_param, ' group by user_id, form_name, user_name, edit_time, user_code, removed HAVING 1 ', filter_param);
