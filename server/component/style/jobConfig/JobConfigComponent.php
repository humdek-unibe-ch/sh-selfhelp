...
require_once __DIR__ . "/JobConfigView.php";

/**
 * A component class for the JobConfigComponent style component.
 * This component renders a textarea form field which is hidden and a button for building the condition with modal form.
 */
class JobConfigComponent extends FormFieldComponent
{
    /* Constructors ***********************************************************/
