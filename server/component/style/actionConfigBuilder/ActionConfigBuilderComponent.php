...
require_once __DIR__ . "/ActionConfigBuilderBuilderView.php";

/**
 * A component class for the ActionConfigBuilderBuilder style component.
 * This component renders a textarea form field which is hidden and a button for building the condition with modal form.
 */
class ActionConfigBuilderComponent extends FormFieldComponent
{
    /* Constructors ***********************************************************/
    ...
    public function __construct($services, $id, $params, $id_page, $entry_record)
    {
        ...
        $view = new ActionConfigBuilderView($model);
