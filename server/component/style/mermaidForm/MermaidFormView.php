...
class MermaidFormView extends FormUserInputView
{
    ...
    /**
     * Get fields that will be editable by the mermaid, we return a json array with a structure
     * name:{
     *   value: field_value,
    ...
    */
    ...
    {
       $this->propagate_input_field_settings($this->form_children, !$this->is_log);
